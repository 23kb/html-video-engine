...
- `<Composition fps={24} durationInFrames={1070} width={1280} height={720}>`; one `<Sequence from={in·fps} durationInFrames={(out−in)·fps}>` per scene.
...
| 0.92 | dark chat card (the copy) at medium size | fill 0.45 (height) zoom 1 | blur push · Easing.bezier(0.16, 1, 0.3, 1) · expo.out | 0.13 | 0.38 | camera |  | w-0.55:13-18; f-001:21-25 [medium] | a blur PULL: the oversized card settles to medium under 2 frames of blur |
| 1.42 | macro on the left end of the input bar inside the card (+ and mic icons, the line streaming) | fill 0.22 (height) zoom 7 | blur push · Easing.bezier(0.16, 1, 0.3, 1) · expo.out | 0.38 | 0.13 | camera |  | w-1.05:15-18; f-001:35-43 [high] | x7 into the input bar at the card bottom |
| 1.92 | macro on the right end of the input bar (send arrow), the arrow cursor rising to it | fill 0.22 (height) zoom 7 | whip · Easing.bezier(0.0001, 0, 0, 1) · expo.out | 0.46 | 1.04 | camera |  | w-1.95:4-18; w-2.35:1-8 [high] | lateral, left end -> right end of the bar; E1 settle creeps to 3.0 s |
| 3.42 | teal terminal icon above the caption the copy | fill 0.13 (height) zoom 1 | cut · Easing.bezier(0, 0, 1, 1) · none | 0.00 | 1.33 | camera |  | w-3.35:6-15; w-3.60:1-9 [high] | reached by seam 4 (clear-then-resolve); settled at 3.75 s |
| 4.75 | dark terminal card with a teal the copy pill | fill 0.47 (height) zoom 1 | cut · Easing.bezier(0, 0, 1, 1) · none | 0.00 | 1.08 | camera |  | w-4.65:8-18; f-003:19-31 [medium] | reached by seam 5 (other); settled at 5.25 s |
| 5.83 | caption the copy with a spinner above the accent word | fill 0.13 (height) zoom 1 | cut · Easing.bezier(0, 0, 1, 1) · none | 0.00 | 0.71 | camera |  | w-5.85:5-10; f-003:45-48 [medium] | reached by seam 6 (clear-then-resolve); settled at 6 s |
| 6.54 | the same caption at x3.3 (macro), spinner top-left, drifting left | fill 0.35 (height) zoom 3.3 | blur push · Easing.bezier(0.16, 1, 0.3, 1) · expo.out | 0.38 | 0.42 | camera |  | w-6.45:7-18 [high] | x3.3 into the caption |
| 7.33 | robot icon above the caption the copy | fill 0.2 (height) zoom 1 | cut · Easing.bezier(0, 0, 1, 1) · none | 0.00 | 1.17 | camera |  | w-7.30:6-14 [high] | reached by seam 8 (clear-then-resolve); settled at 7.583 s |
| 8.50 | big robot with question marks and three floating terminal cards | fill 0.85 (height) zoom 1 | cut · Easing.bezier(0, 0, 1, 1) · none | 0.00 | 1.21 | camera |  | w-8.45:7-17 [high] | reached by seam 9 (clear-then-resolve); settled at 8.917 s |
| 9.71 | man-at-laptop icon above the caption the copy | fill 0.2 (height) zoom 1 | cut · Easing.bezier(0, 0, 1, 1) · none | 0.00 | 0.83 | camera | caption types; small question marks pop in around the man | w-9.60:7-8 [high] | reached by seam 10 (hard cut); settled at 9.708 s |
| 10.54 | the same man at x3 with big question marks | fill 0.9 (height) zoom 3 | blur push · Easing.bezier(0.16, 1, 0.3, 1) · expo.out | 0.38 | 0.79 | camera |  | w-10.40:9-17 [high] | x3 into the man |
| 11.71 | logo lockup: teal mark above the wordmark, then the copy letter-spaced beneath | fill 0.4 (height) zoom 1 | cut · Easing.bezier(0, 0, 1, 1) · none | 0.00 | 1.54 | camera |  | w-11.60:1-13 [medium] | reached by seam 12 (inverse zoom-through); settled at 11.917 s |
| 13.25 | team icon + dash at the left third, caption the copy; robot and terminal icons pop into a thread diagram | fill 0.2 (height) zoom 1 | cut · Easing.bezier(0, 0, 1, 1) · none | 0.00 | 1.50 | camera |  | w-13.15:8-15 [high] | reached by seam 13 (clear-then-resolve); settled at 13.542 s |
| 14.75 | teal monitor icon; a ring draws out around it; three robots pop onto the ring and orbit; the copy beside | fill 0.45 (height) zoom 1 | cut · Easing.bezier(0, 0, 1, 1) · none | 0.00 | 2.67 | camera |  | w-14.80:5-12 [medium] | reached by seam 14 (melt + settle-in); settled at 15.042 s |
| 17.42 | terminal icon at the left third, caption the copy; robot icons pop into a row, then a check | fill 0.13 (height) zoom 1 | cut · Easing.bezier(0, 0, 1, 1) · none | 0.00 | 1.96 | camera |  | w-17.35:7-14 [high] | reached by seam 15 (clear-then-resolve); settled at 17.708 s |
| 19.38 | dark chat-app card with a teal the copy pill and agent progress rows | fill 0.76 (height) zoom 1 | cut · Easing.bezier(0, 0, 1, 1) · none | 0.00 | 1.08 | camera |  | w-19.30:8-18; c-003:20-21 [medium] | reached by seam 16 (other); settled at 19.917 s |
| 20.46 | caption the copy with a spinner that becomes a check | fill 0.13 (height) zoom 1 | cut · Easing.bezier(0, 0, 1, 1) · none | 0.00 | 1.58 | camera | bed bare 2 frames, then caption types; spinner appears, swaps to a check at ~21.2 s | w-20.35:7-12 [medium] | reached by seam 17 (hard cut); settled at 20.458 s |
| 22.04 | robot icon above the caption the copy | fill 0.2 (height) zoom 1 | cut · Easing.bezier(0, 0, 1, 1) · none | 0.00 | 1.71 | camera |  | w-22.10:4-18 [high] | reached by seam 18 (clear-then-resolve); settled at 22.333 s |
| 23.75 | big robot head with a teal steering wheel rising into its hands; display line the copy above | fill 0.85 (height) zoom 4.1 | blur push · Easing.bezier(0.16, 1, 0.3, 1) · expo.out | 0.33 | 2.67 | camera |  | w-23.60:8-16; f-013:1-4 [medium] | x4.1 into the robot; caption replaced under the blur |
| 26.75 | teal gears icon above the caption the copy | fill 0.2 (height) zoom 1 | cut · Easing.bezier(0, 0, 1, 1) · none | 0.00 | 0.83 | camera | caption types; the group re-centres left as it grows | w-26.60:8-10 [high] | reached by seam 20 (hard cut); settled at 26.75 s |
| 27.58 | the same gears at x3 lower-right of centre, display line the copy above | fill 0.7 (height) zoom 3 | blur push · Easing.bezier(0.16, 1, 0.3, 1) · expo.out | 0.54 | 0.63 | camera |  | w-27.40:10-18; f-015:1-3 [medium] | x3 into the gears, re-aimed lower-right; caption replaced under the blur |
| 28.75 | italic headline the copy alone | fill 0.13 (height) zoom 1 | cut · Easing.bezier(0, 0, 1, 1) · none | 0.00 | 1.08 | camera |  | w-28.60:1-14; f-015:19-24 [medium] | reached by seam 22 (other); settled at 28.958 s |
| 29.83 | teal eye icon; ring draws out; three robots pop onto the orbit | fill 0.4 (height) zoom 1 | cut · Easing.bezier(0, 0, 1, 1) · none | 0.00 | 1.46 | camera |  | w-29.80:7-12; f-015:45-48 [medium] | reached by seam 23 (inverse zoom-through); settled at 30.042 s |
| 31.29 | macro eye with the orbit ring as an arc across the frame; robots large and soft at the bottom edge | fill 0.5 (height) zoom 5.5 | blur push · Easing.bezier(0.16, 1, 0.3, 1) · expo.out | 0.38 | 0.08 | camera |  | w-31.15:9-17; w-31.60:1-6 [high] | ANTICIPATE: pull x0.81 over 4 frames, then push x5.5 into the eye |
| 31.75 | macro orbit panned right: arc at the left, a robot riding it, caption the copy centred | fill 0.08 (height) zoom 5.5 | snap · Easing.bezier(0.0001, 0, 0, 1) · expo.out | 0.38 | 0.92 | camera |  | w-31.60:9-18 [medium] | lateral pan right across the macro orbit, ~40% of width in 9 frames, whip-settle |
| 33.04 | man icon above the caption the copy | fill 0.2 (height) zoom 1 | cut · Easing.bezier(0, 0, 1, 1) · none | 0.00 | 1.21 | camera |  | w-33.05:5-11 [medium] | reached by seam 26 (inverse zoom-through); settled at 33.25 s |
| 34.25 | agent network: operator card centre with the copy pill, six agent cards around it with progress bars | fill 0.75 (height) zoom 1 | cut · Easing.bezier(0, 0, 1, 1) · none | 0.00 | 1.67 | camera |  | w-34.30:5-18 [medium] | reached by seam 27 (melt + settle-in); settled at 34.583 s |
| 35.92 | caption the copy with a robot icon fading in above | fill 0.2 (height) zoom 1 | cut · Easing.bezier(0, 0, 1, 1) · none | 0.00 | 0.71 | camera |  | w-35.85:7-11; f-019:1-3 [medium] | reached by seam 28 (clear-then-resolve); settled at 36.083 s |
| 36.63 | the same caption at x3.5 with the robot head, drifting left to rest | fill 0.5 (height) zoom 3.5 | blur push · Easing.bezier(0.0001, 0, 0, 1) · expo.out | 0.38 | 0.92 | camera |  | w-36.60:6-18; f-019:16-35 [high] | x3.5 into the caption; lands moving, drifts left ~15% of width to rest by 37.4 s |
| 37.92 | terminal icon (becomes a check) above the caption the copy | fill 0.2 (height) zoom 1 | cut · Easing.bezier(0, 0, 1, 1) · none | 0.00 | 1.67 | camera |  | w-37.85:6-11; f-019:47-48 [medium] | reached by seam 30 (inverse zoom-through); settled at 38.083 s |
| 39.58 | robot at a laptop with three terminal cards around it, caption the copy above | fill 0.75 (height) zoom 1 | cut · Easing.bezier(0, 0, 1, 1) · none | 0.00 | 1.25 | camera |  | w-39.60:5-16 [medium] | reached by seam 31 (melt + settle-in); settled at 39.917 s |
| 40.83 | logo lockup: mark, wordmark, two-line tagline | fill 0.55 (height) zoom 1 | cut · Easing.bezier(0, 0, 1, 1) · none | 0.00 | 3.75 | camera |  | w-40.65:10-18; w-41.05:1-11 [high] | reached by seam 32 (clear-then-resolve); settled at 41.25 s |

## Sequences

| scene | from (frames) | durationInFrames | subject | seam out | overlap frames |
|---|---:|---:|---|---|---:|
| S1 | 0 | 22 | bare bed, then a small grey chat pill that pops from a dot (fr 2-6) and holds; it grows into the dark chat card fr 15-22 | blur push | 3 |
| S2 | 24 | 10 | dark chat card (the copy) at medium size | blur push | 9 |
| S3 | 42 | 4 | macro on the left end of the input bar inside the card (+ and mic icons, the line streaming) | whip | 11 |
| S4 | 56 | 26 | macro on the right end of the input bar (send arrow), the arrow cursor rising to it | clear-then-resolve | 9 |
| S5 | 90 | 24 | teal terminal icon above the caption the copy | other | 13 |
| S6 | 126 | 14 | dark terminal card with a teal the copy pill | clear-then-resolve | 5 |
| S7 | 144 | 13 | caption the copy with a spinner above the accent word | blur push | 9 |
| S8 | 165 | 11 | the same caption at x3.3 (macro), spinner top-left, drifting left | clear-then-resolve | 7 |
| S9 | 182 | 22 | robot icon above the caption the copy | clear-then-resolve | 11 |
| S10 | 214 | 19 | big robot with question marks and three floating terminal cards | hard cut | 1 |
| S11 | 233 | 20 | man-at-laptop icon above the caption the copy | blur push | 9 |
| S12 | 261 | 20 | the same man at x3 with big question marks | inverse zoom-through | 6 |
| S13 | 286 | 32 | logo lockup: teal mark above the wordmark, then the copy letter-spaced beneath | clear-then-resolve | 8 |
| S14 | 325 | 29 | team icon + dash at the left third, caption the copy; robot and terminal icons pop into a thread diagram | melt + settle-in | 8 |
| S15 | 361 | 57 | teal monitor icon; a ring draws out around it; three robots pop onto the ring and orbit; the copy beside | clear-then-resolve | 8 |
| S16 | 425 | 40 | terminal icon at the left third, caption the copy; robot icons pop into a row, then a check | other | 14 |
| S17 | 478 | 13 | dark chat-app card with a teal the copy pill and agent progress rows | hard cut | 1 |
| S18 | 491 | 38 | caption the copy with a spinner that becomes a check | clear-then-resolve | 8 |
| S19 | 536 | 34 | robot icon above the caption the copy | blur push | 8 |
| S20 | 577 | 65 | big robot head with a teal steering wheel rising into its hands; display line the copy above | hard cut | 1 |
| S21 | 642 | 20 | teal gears icon above the caption the copy | blur push | 13 |
| S22 | 674 | 16 | the same gears at x3 lower-right of centre, display line the copy above | other | 6 |
| S23 | 695 | 21 | italic headline the copy alone | inverse zoom-through | 6 |
| S24 | 721 | 30 | teal eye icon; ring draws out; three robots pop onto the orbit | blur push | 9 |
| S25 | 759 | 3 | macro eye with the orbit ring as an arc across the frame; robots large and soft at the bottom edge | other | 9 |
| S26 | 770 | 23 | macro orbit panned right: arc at the left, a robot riding it, caption the copy centred | inverse zoom-through | 6 |
| S27 | 798 | 24 | man icon above the caption the copy | melt + settle-in | 9 |
| S28 | 830 | 32 | agent network: operator card centre with the copy pill, six agent cards around it with progress bars | clear-then-resolve | 5 |
| S29 | 866 | 13 | caption the copy with a robot icon fading in above | blur push | 9 |
| S30 | 887 | 23 | the same caption at x3.5 with the robot head, drifting left to rest | inverse zoom-through | 5 |
| S31 | 914 | 36 | terminal icon (becomes a check) above the caption the copy | melt + settle-in | 9 |
| S32 | 958 | 22 | robot at a laptop with three terminal cards around it, caption the copy above | clear-then-resolve | 11 |
| S33 | 990 | 80 | logo lockup: mark, wordmark, two-line tagline | — | — |
...
|---|---|---|---:|---|---|
| E1 whip-settle | `expo.out` | (0.0001, 0, 0, 1) | 12 f | the whip settle along the input bar (creeps to 3.0 s), the pan settle at 31.75 s, the post-push drifts (36.96-37.4 s), the slit unfold heights | `Easing.bezier(0.0001, 0, 0, 1)` |
| sharpen-in | `expo.out` | (0.16, 1, 0.3, 1) | 4 f | soft-then-sharp arrivals after every blur push and resolve; settle-from-large arrivals (3-6 frames) | `Easing.bezier(0.16, 1, 0.3, 1)` |
| melt-out | `power2.in` | (0.11, 0, 0.5, 0) | 3 f | blur + dim exits to the bed (1-5 frames) | `Easing.bezier(0.11, 0, 0.5, 0)` |
| pull-back exit | `power3.in` | (0.32, 0, 0.67, 0) | 8 f | the scale-down exits before the inverse zoom-throughs and before the copy (x1 -> 0.35 over 8 frames, accelerating) | `Easing.bezier(0.32, 0, 0.67, 0)` |
| linear | `none` | (0, 0, 1, 1) | 1 f | type-on characters, hard cuts, icon swaps, the smear frame | `Easing.bezier(0, 0, 1, 1)` |
| object rise / draw | `power3.out` | (0.33, 1, 0.68, 1) | 10 f | the steering wheel rising into the robot's hands (24.58-25.0 s), the ring drawing out from an icon (6-7 frames) | `Easing.bezier(0.33, 1, 0.68, 1)` |
