...
Added 2026-08-28 after Umair's QC note on one tutorial: *"I feel like postIntro is not clear for tutorials — claude is not clear about it."* He was right. Everything below this section was written for editorial / announcement films, and applying it unchanged to a tutorial produced a botched beat neither of us could map to a rule (receipt `cpa` 13–14).
