 ...
 * Source: WordPress 7.1.1 core, wp-includes/js/jquery/ui/core.min.js
 * Library: jQuery UI 1.14.2 core (widget, position, data, keycode, ...). Script handle
 * 'jquery-ui-core' (wp-includes/script-loader.php:918). WordPress prints the inline
 * 'jQuery.uiBackCompat = true;' before it (:919); the product file sets the same flag
 * before it loads this file.
 * Copied byte for byte below this comment. md5 of the original: ffb9792c762c28c883fbda04cb87bfd7
 */
