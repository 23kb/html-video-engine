 ...
 * Source: sugar-calendar 3.14.0 (Pro), sugar-calendar/assets/lib/jquery-minicolors/jquery.minicolors.min.js
 * Library: jQuery MiniColors 2.3.6, as the plugin ships it. Script handle
 * 'sugar-calendar-vendor-minicolors' (sugar-calendar/src/Admin/Area.php:1312-1318), used by
 * 'sugar-calendar-admin-color-scheme' (:1437-1443) on Settings > Emails
 * (src/Admin/Pages/Settings/EmailsConfigTab.php:66-67) and Settings > Payments
 * (includes/common/Features/EventTicketing/includes/admin/assets.php:84-85).
 * Its stylesheet is not vendored: its rules are in the capture.
 * Copied byte for byte below this comment. md5 of the original: b061c844d60dc5b0aa12d898237d1c10
 */
//
