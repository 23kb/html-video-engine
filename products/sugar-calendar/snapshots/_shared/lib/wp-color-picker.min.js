 ...
 * Source: WordPress 7.1.1 core, wp-admin/js/color-picker.min.js
 * Library: WordPress's wpColorPicker jQuery UI widget (source wp-admin/js/color-picker.js).
 * Script handle 'wp-color-picker', depending on 'iris' (wp-includes/script-loader.php:1506).
 * The plugin runs it on the Calendars screens: sugar-calendar/src/Admin/Area.php:1419-1425
 * (admin-calendar.js) and includes/classes/terms/class-term-colors.php:108-112 (term-color.js).
 * Its stylesheet, wp-admin/css/color-picker.min.css, is not vendored: its rules are in the capture.
 * Copied byte for byte below this comment. md5 of the original: 9496606c15a420572b251de4868a6b63
 */
