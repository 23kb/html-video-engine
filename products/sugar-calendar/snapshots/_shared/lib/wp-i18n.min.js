 ...
 * Source: WordPress 7.1.1 core, wp-includes/js/dist/i18n.min.js
 * Library: @wordpress/i18n (wp.i18n). Script handle 'wp-i18n' (wp-includes/assets/script-loader-packages.php:601).
 * 'wp-color-picker' needs it through set_translations (wp-includes/script-loader.php:1507);
 * color-picker.js reads wp.i18n.__ (wp-admin/js/color-picker.js:14). On this en_US site no
 * locale data is set, so __() returns the source string.
 * Copied byte for byte below this comment. md5 of the original: d2f655e068f223e5da12d436aac88d38
 */
