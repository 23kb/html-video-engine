 ...
 * Source: wp-mail-smtp-pro 4.9.0, assets/js/vendor/chart.min.js
 * Library: Chart.js v4.4.9 as the plugin ships it: the global is renamed
 * WPMailSMTPChart (the plugin's own note is in the header below).
 * Enqueued by the plugin as 'wp-mail-smtp-chart', version 4.4.9, depending on
 * 'moment': src/Pro/Emails/Logs/Reports/Admin.php:145-151 and
 * src/Pro/Admin/DashboardWidget.php:172-178.
 * Copied byte for byte below this comment. md5 of the original: 049249b03180ea0de714e969c8e9e7d2
 */
/*!
 * Chart.js v4.4.9
