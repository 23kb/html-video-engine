...
> Source: `products/wp-mail-smtp/snapshots/admin-about/index.html`
> Generator: `tools/generate-snapshot-catalog.js`
> 29 selector entries across 2 sections.

Provenance anchor form: `products/wp-mail-smtp/snapshots/admin-about/catalog.md#<anchor>`.
...
| <a id="id--wp-mail-smtp"></a>`id--wp-mail-smtp` | `#wp-mail-smtp` | div | About Us | 1 |
...
| Anchor | Selector | Tag | Text | Count |
| --- | --- | --- | --- | --- |
| <a id="class--wp-mail-smtp-admin-about-section"></a>`class--wp-mail-smtp-admin-about-section` | `.wp-mail-smtp-admin-about-section` | div | Hello and welcome to WP Mail SMTP, the easiest and most pop… | 1 |
...
| <a id="class--wp-mail-smtp-page-content"></a>`class--wp-mail-smtp-page-content` | `.wp-mail-smtp-page-content` | div | About Us Hello and welcome to WP Mail SMTP, the easiest and… | 1 |
