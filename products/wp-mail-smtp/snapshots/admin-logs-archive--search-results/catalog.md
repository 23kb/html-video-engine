# Catalog — `admin-logs-archive--search-results`

> Auto-generated. Do not edit by hand.
> Source: `products/wp-mail-smtp/snapshots/admin-logs-archive--search-results/index.html`
> Generator: `tools/generate-snapshot-catalog.js`
> 73 selector entries across 2 sections.

Provenance anchor form: `products/wp-mail-smtp/snapshots/admin-logs-archive--search-results/catalog.md#<anchor>`.
...
| <a id="id--cb-select-all-2"></a>`id--cb-select-all-2` | `#cb-select-all-2` | input | Select All | 1 |
...
| <a id="id--date_sent"></a>`id--date_sent` | `#date_sent` | th | Date Sent | 1 |
...
| <a id="id--doaction2"></a>`id--doaction2` | `#doaction2` | input | 10 items « ‹ Current Page | 1 |
...
| <a id="id--subject"></a>`id--subject` | `#subject` | th | Subject | 1 |
...
| <a id="id--wp-mail-smtp-delete-log-entries-nonce"></a>`id--wp-mail-smtp-delete-log-entries-nonce` | `#wp-mail-smtp-delete-log-entries-nonce` | input | Delete All Logs 10 items « | 1 |
...
| <a id="id--wp-mail-smtp-logs-archive-search-input"></a>`id--wp-mail-smtp-logs-archive-search-input` | `#wp-mail-smtp-logs-archive-search-input` | input | All&nbsp; (10) \| | 1 |
| <a id="id--wp-mail-smtp-reset-filter"></a>`id--wp-mail-smtp-reset-filter` | `#wp-mail-smtp-reset-filter` | div | Found 10 email logs where Email Address is " mateo.silva@ex… | 1 |
...
| <a id="class--wp-mail-smtp-page-content"></a>`class--wp-mail-smtp-page-content` | `.wp-mail-smtp-page-content` | div | Found 10 email logs where Email Address is " mateo.silva@ex… | 1 |
