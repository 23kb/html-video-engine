# Catalog — `admin-logs-archive--status-blocked`

> Auto-generated. Do not edit by hand.
> Source: `products/wp-mail-smtp/snapshots/admin-logs-archive--status-blocked/index.html`
> Generator: `tools/generate-snapshot-catalog.js`
> 72 selector entries across 2 sections.

Provenance anchor form: `products/wp-mail-smtp/snapshots/admin-logs-archive--status-blocked/catalog.md#<anchor>`.
...
| <a id="id--wp-mail-smtp-delete-log-entries-nonce"></a>`id--wp-mail-smtp-delete-log-entries-nonce` | `#wp-mail-smtp-delete-log-entries-nonce` | input | Delete All Logs 6 items « | 1 |
