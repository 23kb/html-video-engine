# Catalog — `admin-logs-archive--status-failed`

> Auto-generated. Do not edit by hand.
> Source: `products/wp-mail-smtp/snapshots/admin-logs-archive--status-failed/index.html`
> Generator: `tools/generate-snapshot-catalog.js`
> 72 selector entries across 2 sections.

Provenance anchor form: `products/wp-mail-smtp/snapshots/admin-logs-archive--status-failed/catalog.md#<anchor>`.
...
| <a id="id--current-page-selector"></a>`id--current-page-selector` | `#current-page-selector` | input | of 5 Next page › | 1 |
...
| <a id="id--table-paging"></a>`id--table-paging` | `#table-paging` | span | 1 of 5 | 1 |
...
| <a id="id--wp-mail-smtp-delete-log-entries-nonce"></a>`id--wp-mail-smtp-delete-log-entries-nonce` | `#wp-mail-smtp-delete-log-entries-nonce` | input | Delete All Logs 49 items « ‹ | 1 |
...
| <a id="id--wp-mail-smtp-logs-archive-search-input"></a>`id--wp-mail-smtp-logs-archive-search-input` | `#wp-mail-smtp-logs-archive-search-input` | input | All&nbsp; (2300) \| Sent&nbsp; | 1 |
