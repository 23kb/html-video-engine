# Catalog — `admin-logs-archive--status-sent`

> Auto-generated. Do not edit by hand.
> Source: `products/wp-mail-smtp/snapshots/admin-logs-archive--status-sent/index.html`
> Generator: `tools/generate-snapshot-catalog.js`
> 72 selector entries across 2 sections.

Provenance anchor form: `products/wp-mail-smtp/snapshots/admin-logs-archive--status-sent/catalog.md#<anchor>`.
...
| <a id="id--current-page-selector"></a>`id--current-page-selector` | `#current-page-selector` | input | of 89 Next page › | 1 |
...
| <a id="id--doaction2"></a>`id--doaction2` | `#doaction2` | input | 881 items « ‹ Current Page | 1 |
...
| <a id="id--table-paging"></a>`id--table-paging` | `#table-paging` | span | 1 of 89 | 1 |
...
| <a id="id--wp-mail-smtp-delete-log-entries-nonce"></a>`id--wp-mail-smtp-delete-log-entries-nonce` | `#wp-mail-smtp-delete-log-entries-nonce` | input | Delete All Logs 881 items « ‹ | 1 |
...
| <a id="class--wp-mail-smtp-page-content"></a>`class--wp-mail-smtp-page-content` | `.wp-mail-smtp-page-content` | div |  | 1 |
