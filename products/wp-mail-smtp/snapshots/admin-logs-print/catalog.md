# Catalog — `admin-logs-print`

> Auto-generated. Do not edit by hand.
> Source: `products/wp-mail-smtp/snapshots/admin-logs-print/index.html`
> Generator: `tools/generate-snapshot-catalog.js`
> 1 selector entries across 1 sections.

Provenance anchor form: `products/wp-mail-smtp/snapshots/admin-logs-print/catalog.md#<anchor>`.
...
| --- | --- | --- | --- | --- |
| <a id="id--print"></a>`id--print` | `#print` | div | &nbsp; Close Print | 1 |
