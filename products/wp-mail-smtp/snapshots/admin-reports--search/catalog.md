# Catalog — `admin-reports--search`

> Auto-generated. Do not edit by hand.
> Source: `products/wp-mail-smtp/snapshots/admin-reports--search/index.html`
> Generator: `tools/generate-snapshot-catalog.js`
> 57 selector entries across 2 sections.

Provenance anchor form: `products/wp-mail-smtp/snapshots/admin-reports--search/catalog.md#<anchor>`.
...
| --- | --- | --- | --- | --- |
| <a id="id--adv-settings"></a>`id--adv-settings` | `#adv-settings` | form | Columns Subject Total | 1 |
| <a id="id--click_count"></a>`id--click_count` | `#click_count` | th | Click Count Sort ascending. | 1 |
| <a id="id--click_count-hide"></a>`id--click_count-hide` | `#click_count-hide` | input | Click Count Graph Pagination Number of items per page: | 1 |
...
| <a id="id--graph"></a>`id--graph` | `#graph` | th | Graph | 1 |
| <a id="id--graph-hide"></a>`id--graph-hide` | `#graph-hide` | input | Graph Pagination Number of items per page: | 1 |
| <a id="id--open_count"></a>`id--open_count` | `#open_count` | th | Open Count Sort ascending. | 1 |
| <a id="id--open_count-hide"></a>`id--open_count-hide` | `#open_count-hide` | input | Open Count Click Count Graph Paginatio | 1 |
...
| <a id="id--screen-options-wrap"></a>`id--screen-options-wrap` | `#screen-options-wrap` | div | Columns Subject | 1 |
| <a id="id--screenoptionnonce"></a>`id--screenoptionnonce` | `#screenoptionnonce` | input | Screen Options | 1 |
| <a id="id--sent_count"></a>`id--sent_count` | `#sent_count` | th | Sent Sort ascending. | 1 |
| <a id="id--sent_count-hide"></a>`id--sent_count-hide` | `#sent_count-hide` | input | Sent Failed Open Count | 1 |
...
| <a id="id--subject-hide"></a>`id--subject-hide` | `#subject-hide` | input | Subject Total Sent | 1 |
| <a id="id--table-paging"></a>`id--table-paging` | `#table-paging` | span | 1 of 2 | 1 |
| <a id="id--the-list"></a>`id--the-list` | `#the-list` | tbody | Thanks for your order Show more details | 1 |
| <a id="id--toplevel_page_wp-mail-smtp"></a>`id--toplevel_page_wp-mail-smtp` | `#toplevel_page_wp-mail-smtp` | li |  | 1 |
| <a id="id--total_count"></a>`id--total_count` | `#total_count` | th | Total Sort ascending. | 1 |
| <a id="id--total_count-hide"></a>`id--total_count-hide` | `#total_count-hide` | input | Total Sent Failed | 1 |
| <a id="id--unsent_count"></a>`id--unsent_count` | `#unsent_count` | th | Failed Sort ascending. | 1 |
| <a id="id--unsent_count-hide"></a>`id--unsent_count-hide` | `#unsent_count-hide` | input | Failed Open Count Click Count | 1 |
| <a id="id--wp_mail_smtp_report_items_per_page"></a>`id--wp_mail_smtp_report_items_per_page` | `#wp_mail_smtp_report_items_per_page` | input |  | 1 |
...
| <a id="id--wp-mail-smtp"></a>`id--wp-mail-smtp` | `#wp-mail-smtp` | div | Email Reports | 1 |
...
| <a id="id--wp-mail-smtp-reports-search-input-search-input"></a>`id--wp-mail-smtp-reports-search-input-search-input` | `#wp-mail-smtp-reports-search-input-search-input` | input |  | 1 |
| <a id="id--wp-mail-smtp-reset-filter"></a>`id--wp-mail-smtp-reset-filter` | `#wp-mail-smtp-reset-filter` | div | Found 20 items where the subject contains order | 1 |
...
| <a id="class--wp-mail-smtp-filter-date__control"></a>`class--wp-mail-smtp-filter-date__control` | `.wp-mail-smtp-filter-date__control` | select | Last 7 days Last 14 days Last 30 days Custom Date Range | 3 |
...
| <a id="class--wp-mail-smtp-page-content"></a>`class--wp-mail-smtp-page-content` | `.wp-mail-smtp-page-content` | div | Email Reports | 1 |
| <a id="class--wp-mail-smtp-toggle-single-stats-btn-container"></a>`class--wp-mail-smtp-toggle-single-stats-btn-container` | `.wp-mail-smtp-toggle-single-stats-btn-container` | div |  | 17 |
