# Catalog — `admin-settings-logs--off`

> Auto-generated. Do not edit by hand.
> Source: `products/wp-mail-smtp/snapshots/admin-settings-logs--off/index.html`
> Generator: `tools/generate-snapshot-catalog.js`
> 55 selector entries across 2 sections.

Provenance anchor form: `products/wp-mail-smtp/snapshots/admin-settings-logs--off/catalog.md#<anchor>`.
...
| <a id="id--wp-mail-smtp-setting-logs_click_link_tracking"></a>`id--wp-mail-smtp-setting-logs_click_link_tracking` | `#wp-mail-smtp-setting-logs_click_link_tracking` | input | On Off Track clicked links in emails. This will allow you t… | 1 |
| <a id="id--wp-mail-smtp-setting-logs_enabled"></a>`id--wp-mail-smtp-setting-logs_enabled` | `#wp-mail-smtp-setting-logs_enabled` | input | On Off Keep a record of basic details for all emails sent f… | 1 |
| <a id="id--wp-mail-smtp-setting-logs_log_email_content"></a>`id--wp-mail-smtp-setting-logs_log_email_content` | `#wp-mail-smtp-setting-logs_log_email_content` | input | On Off Keep a record of all content for all emails sent fro… | 1 |
| <a id="id--wp-mail-smtp-setting-logs_open_email_tracking"></a>`id--wp-mail-smtp-setting-logs_open_email_tracking` | `#wp-mail-smtp-setting-logs_open_email_tracking` | input | On Off Track when an email is opened. This will allow you t… | 1 |
| <a id="id--wp-mail-smtp-setting-logs_save_attachments"></a>`id--wp-mail-smtp-setting-logs_save_attachments` | `#wp-mail-smtp-setting-logs_save_attachments` | input | On Off Save the sent attachments to the Email Log. All sent… | 1 |
...
| <a id="class--wp-mail-smtp-toggle"></a>`class--wp-mail-smtp-toggle` | `.wp-mail-smtp-toggle` | label | On Off | 5 |
