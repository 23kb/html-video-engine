# Catalog — `admin-tools-action-scheduler--failed`

> Auto-generated. Do not edit by hand.
> Source: `products/wp-mail-smtp/snapshots/admin-tools-action-scheduler--failed/index.html`
> Generator: `tools/generate-snapshot-catalog.js`
> 63 selector entries across 2 sections.

Provenance anchor form: `products/wp-mail-smtp/snapshots/admin-tools-action-scheduler--failed/catalog.md#<anchor>`.
...
| --- | --- | --- | --- | --- |
| <a id="id--action-scheduler-filter"></a>`id--action-scheduler-filter` | `#action-scheduler-filter` | form | Se | 1 |
| <a id="id--adv-settings"></a>`id--adv-settings` | `#adv-settings` | form | Columns Hook Status | 1 |
| <a id="id--args"></a>`id--args` | `#args` | th | Arguments | 1 |
| <a id="id--args-hide"></a>`id--args-hide` | `#args-hide` | input | Arguments Group Recurrence | 1 |
...
| <a id="id--cb-select-all-1"></a>`id--cb-select-all-1` | `#cb-select-all-1` | input | Select All Hook | 1 |
| <a id="id--cb-select-all-2"></a>`id--cb-select-all-2` | `#cb-select-all-2` | input | Select All Hook | 1 |
| <a id="id--claim_id"></a>`id--claim_id` | `#claim_id` | th | Claim ID Sort descending. | 1 |
| <a id="id--claim_id-hide"></a>`id--claim_id-hide` | `#claim_id-hide` | input | Claim ID Pagination Number of items per page: | 1 |
...
| <a id="id--doaction"></a>`id--doaction` | `#doaction` | input | 12 items « ‹ Current Page | 1 |
...
| <a id="id--group"></a>`id--group` | `#group` | th | Group Sort descending. | 1 |
| <a id="id--group-hide"></a>`id--group-hide` | `#group-hide` | input | Group Recurrence Scheduled Date | 1 |
| <a id="id--hook"></a>`id--hook` | `#hook` | th | Hook Sort descending. | 1 |
| <a id="id--hook-hide"></a>`id--hook-hide` | `#hook-hide` | input | Hook Status Arguments | 1 |
| <a id="id--log_entries"></a>`id--log_entries` | `#log_entries` | th | Log | 1 |
| <a id="id--log_entries-hide"></a>`id--log_entries-hide` | `#log_entries-hide` | input | Log Claim ID Pagination Number of items per page: | 1 |
| <a id="id--plugin-search-input"></a>`id--plugin-search-input` | `#plugin-search-input` | input |  | 1 |
| <a id="id--recurrence"></a>`id--recurrence` | `#recurrence` | th | Recurrence | 1 |
| <a id="id--recurrence-hide"></a>`id--recurrence-hide` | `#recurrence-hide` | input | Recurrence Scheduled Date Log | 1 |
| <a id="id--schedule"></a>`id--schedule` | `#schedule` | th | Scheduled Date Sort descending. | 1 |
| <a id="id--schedule-hide"></a>`id--schedule-hide` | `#schedule-hide` | input | Scheduled Date Log Claim ID P | 1 |
...
| <a id="id--status-hide"></a>`id--status-hide` | `#status-hide` | input | Status Arguments Group | 1 |
| <a id="id--table-paging"></a>`id--table-paging` | `#table-paging` | span | 1 of 2 | 1 |
| <a id="id--the-list"></a>`id--the-list` | `#the-list` | tbody | wpforms_admin_addons_cache_update ID: 787 Show more details | 1 |
| <a id="id--toplevel_page_wp-mail-smtp"></a>`id--toplevel_page_wp-mail-smtp` | `#toplevel_page_wp-mail-smtp` | li |  | 1 |
| <a id="id--wp_mail_smtp_page_wp_mail_smtp_tools_per_page"></a>`id--wp_mail_smtp_page_wp_mail_smtp_tools_per_page` | `#wp_mail_smtp_page_wp_mail_smtp_tools_per_page` | input |  | 1 |
...
| <a id="class--wp-mail-smtp-page-content"></a>`class--wp-mail-smtp-page-content` | `.wp-mail-smtp-page-content` | div | Scheduled Actions Scheduled Actions WP Mail SMTP is using t… | 1 |
