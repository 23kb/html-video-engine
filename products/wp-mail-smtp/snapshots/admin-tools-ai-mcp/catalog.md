...
> Source: `products/wp-mail-smtp/snapshots/admin-tools-ai-mcp/index.html`
> Generator: `tools/generate-snapshot-catalog.js`
> 34 selector entries across 2 sections.

Provenance anchor form: `products/wp-mail-smtp/snapshots/admin-tools-ai-mcp/catalog.md#<anchor>`.
...
| Anchor | Selector | Tag | Text | Count |
| --- | --- | --- | --- | --- |
| <a id="class--wp-mail-smtp-ai-mcp-cta-row"></a>`class--wp-mail-smtp-ai-mcp-cta-row` | `.wp-mail-smtp-ai-mcp-cta-row` | div | Set Up WPVibe | 1 |
| <a id="class--wp-mail-smtp-ai-mcp-docs-link"></a>`class--wp-mail-smtp-ai-mcp-docs-link` | `.wp-mail-smtp-ai-mcp-docs-link` | a | View Abilities API Documentation | 1 |
| <a id="class--wp-mail-smtp-ai-mcp-wpvibe-button"></a>`class--wp-mail-smtp-ai-mcp-wpvibe-button` | `.wp-mail-smtp-ai-mcp-wpvibe-button` | a | Set Up WPVibe | 1 |
| <a id="class--wp-mail-smtp-btn"></a>`class--wp-mail-smtp-btn` | `.wp-mail-smtp-btn` | a | Set Up WPVibe | 1 |
| <a id="class--wp-mail-smtp-btn-blueish"></a>`class--wp-mail-smtp-btn-blueish` | `.wp-mail-smtp-btn-blueish` | a | Set Up WPVibe | 1 |
| <a id="class--wp-mail-smtp-btn-lg"></a>`class--wp-mail-smtp-btn-lg` | `.wp-mail-smtp-btn-lg` | a | Set Up WPVibe | 1 |
...
| <a id="class--wp-mail-smtp-page-content"></a>`class--wp-mail-smtp-page-content` | `.wp-mail-smtp-page-content` | div | AI MCP WordPress Abilities API + WP Mail SMTP Use WP Mail S… | 1 |
