# Catalog — `admin-entries-imported`

> Auto-generated. Do not edit by hand.
> Source: `snapshots/admin-entries-imported/index.html`
> Generator: `tools/generate-snapshot-catalog.js`
> 82 selector entries across 3 sections.

Provenance anchor form: `snapshots/admin-entries-imported/catalog.md#<anchor>`.
...
| <a id="id--current-page-selector"></a>`id--current-page-selector` | `#current-page-selector` | input | of 40 | 1 |
...
| <a id="id--doaction2"></a>`id--doaction2` | `#doaction2` | input | 1,200 items « ‹ Current Page | 1 |
...
| <a id="id--table-paging"></a>`id--table-paging` | `#table-paging` | span | 1 of 40 | 1 |
...
| <a id="id--wpforms_field_2"></a>`id--wpforms_field_2` | `#wpforms_field_2` | th | Email | 1 |
| <a id="id--wpforms_field_2-foot"></a>`id--wpforms_field_2-foot` | `#wpforms_field_2-foot` | th | Email | 1 |
| <a id="id--wpforms_field_3"></a>`id--wpforms_field_3` | `#wpforms_field_3` | th | Comment or Message | 1 |
| <a id="id--wpforms_field_3-foot"></a>`id--wpforms_field_3-foot` | `#wpforms_field_3-foot` | th | Comment or Message | 1 |
| <a id="id--wpforms-entries-list"></a>`id--wpforms-entries-list` | `#wpforms-entries-list` | div | Entries Select Form Sullie's Bakery Contact Form | 1 |
| <a id="id--wpforms-entries-search-input"></a>`id--wpforms-entries-search-input` | `#wpforms-entries-search-input` | input | Search | 1 |
| <a id="id--wpforms-entries-table"></a>`id--wpforms-entries-table` | `#wpforms-entries-table` | form | All&nbsp; ( 1200 ) | 1 |
| <a id="id--wpforms-entries-table-edit-columns-select"></a>`id--wpforms-entries-table-edit-columns-select` | `#wpforms-entries-table-edit-columns-select` | select | Name Email Comment or Message Phone Entry ID Entry Notes Da… | 1 |
...
| Anchor | Selector | Tag | Text | Count |
| --- | --- | --- | --- | --- |
| <a id="data-field-type--email"></a>`data-field-type--email` | `[data-field-type="email"]` | div | ethan.barnes@gmail.com | 30 |
| <a id="data-field-type--name"></a>`data-field-type--name` | `[data-field-type="name"]` | div | Ethan Barnes | 30 |
| <a id="data-field-type--textarea"></a>`data-field-type--textarea` | `[data-field-type="textarea"]` | div | Brownie Box — Gift wrap if possible. | 30 |
...
| Anchor | Selector | Tag | Text | Count |
| --- | --- | --- | --- | --- |
| <a id="class--wpforms-admin-content"></a>`class--wpforms-admin-content` | `.wpforms-admin-content` | div | Select Form Sullie's Bakery Contact Form | 1 |
| <a id="class--wpforms-entries-table-edit-columns-select"></a>`class--wpforms-entries-table-edit-columns-select` | `.wpforms-entries-table-edit-columns-select` | select | Name Email Comment or Message Phone Entry ID Entry Notes Da… | 1 |
| <a id="class--wpforms-filter-date-selector"></a>`class--wpforms-filter-date-selector` | `.wpforms-filter-date-selector` | input | Filter 1,200 items | 2 |
...
| <a id="class--wpforms-form-search-box-field"></a>`class--wpforms-form-search-box-field` | `.wpforms-form-search-box-field` | select | Any form field Name Email Comment or Message Phone Entry ID… | 1 |
...
| <a id="class--wpforms-list-table-ext-edit-columns-select"></a>`class--wpforms-list-table-ext-edit-columns-select` | `.wpforms-list-table-ext-edit-columns-select` | select | Name Email Comment or Message Phone Entry ID Entry Notes Da… | 1 |
...
| <a id="class--wpforms-multiselect-checkbox-dropdown"></a>`class--wpforms-multiselect-checkbox-dropdown` | `.wpforms-multiselect-checkbox-dropdown` | div | Name Email Comment or Message Phone | 1 |
...
| <a id="class--wpforms-multiselect-checkbox-search"></a>`class--wpforms-multiselect-checkbox-search` | `.wpforms-multiselect-checkbox-search` | input | Form Fields Name Email | 1 |
