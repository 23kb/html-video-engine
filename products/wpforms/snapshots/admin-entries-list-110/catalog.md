# Catalog — `admin-entries-list-110`

> Auto-generated. Do not edit by hand.
> Source: `snapshots/admin-entries-list-110/index.html`
> Generator: `tools/generate-snapshot-catalog.js`
> 88 selector entries across 3 sections.

Provenance anchor form: `snapshots/admin-entries-list-110/catalog.md#<anchor>`.
...
| <a id="id--current-page-selector"></a>`id--current-page-selector` | `#current-page-selector` | input | of 22 | 1 |
...
| <a id="id--doaction2"></a>`id--doaction2` | `#doaction2` | input | 652 items « ‹ Current Page | 1 |
...
| <a id="id--table-paging"></a>`id--table-paging` | `#table-paging` | span | 1 of 22 | 1 |
...
| <a id="id--wpforms-entries-list"></a>`id--wpforms-entries-list` | `#wpforms-entries-list` | div | Entries Select Form Customer Support | 1 |
...
| <a id="id--wpforms-entries-table-edit-columns-select"></a>`id--wpforms-entries-table-edit-columns-select` | `#wpforms-entries-table-edit-columns-select` | select | Name Email Comment or Message Phone Phone Entry ID Entry No… | 1 |
...
| Anchor | Selector | Tag | Text | Count |
| --- | --- | --- | --- | --- |
| <a id="data-field-type--email"></a>`data-field-type--email` | `[data-field-type="email"]` | div | isla.young775@outlook.com | 30 |
| <a id="data-field-type--name"></a>`data-field-type--name` | `[data-field-type="name"]` | div | Isla Young | 30 |
| <a id="data-field-type--textarea"></a>`data-field-type--textarea` | `[data-field-type="textarea"]` | div | I would like to ask about catering for an office event of a… | 30 |
...
| Anchor | Selector | Tag | Text | Count |
| --- | --- | --- | --- | --- |
| <a id="class--wpforms-admin-content"></a>`class--wpforms-admin-content` | `.wpforms-admin-content` | div | Select Form Customer Support | 1 |
| <a id="class--wpforms-entries-table-edit-columns-select"></a>`class--wpforms-entries-table-edit-columns-select` | `.wpforms-entries-table-edit-columns-select` | select | Name Email Comment or Message Phone Phone Entry ID Entry No… | 1 |
| <a id="class--wpforms-filter-date-selector"></a>`class--wpforms-filter-date-selector` | `.wpforms-filter-date-selector` | input | Filter 652 items | 2 |
...
| <a id="class--wpforms-form-search-box-field"></a>`class--wpforms-form-search-box-field` | `.wpforms-form-search-box-field` | select | Any form field Name Email Comment or Message Phone Phone En… | 1 |
...
| <a id="class--wpforms-list-table-ext-edit-columns-select"></a>`class--wpforms-list-table-ext-edit-columns-select` | `.wpforms-list-table-ext-edit-columns-select` | select | Name Email Comment or Message Phone Phone Entry ID Entry No… | 1 |
