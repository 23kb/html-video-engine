...
| <a id="id--wpforms_field_3"></a>`id--wpforms_field_3` | `#wpforms_field_3` | th | Paragraph Text | 1 |
...
| Anchor | Selector | Tag | Text | Count |
| --- | --- | --- | --- | --- |
| <a id="class--wpforms-admin-content"></a>`class--wpforms-admin-content` | `.wpforms-admin-content` | div | Select Form Entries Fixture | 1 |
| <a id="class--wpforms-entries-table-edit-columns-select"></a>`class--wpforms-entries-table-edit-columns-select` | `.wpforms-entries-table-edit-columns-select` | select | Name Email Paragraph Text Entry ID Entry Notes Date Entry T… | 1 |
| <a id="class--wpforms-filter-date-selector"></a>`class--wpforms-filter-date-selector` | `.wpforms-filter-date-selector` | input | Filter 5 items | 2 |
...
| <a id="class--wpforms-form-search-box-field"></a>`class--wpforms-form-search-box-field` | `.wpforms-form-search-box-field` | select | Any form field Name Email Paragraph Text Entry ID Entry Not… | 1 |
...
| <a id="class--wpforms-list-table-ext-edit-columns-select"></a>`class--wpforms-list-table-ext-edit-columns-select` | `.wpforms-list-table-ext-edit-columns-select` | select | Name Email Paragraph Text Entry ID Entry Notes Date Entry T… | 1 |
...
| <a id="class--wpforms-multiselect-checkbox-dropdown"></a>`class--wpforms-multiselect-checkbox-dropdown` | `.wpforms-multiselect-checkbox-dropdown` | div | Name Email Paragraph Text | 1 |
