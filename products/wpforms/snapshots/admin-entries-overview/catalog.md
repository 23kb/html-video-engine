# Catalog — `admin-entries-overview`
...
| <a id="id--created-hide"></a>`id--created-hide` | `#created-hide` | input | Created Last Entry All Time | 1 |
...
| <a id="id--graph-hide"></a>`id--graph-hide` | `#graph-hide` | input | Graph Pagination Number of forms per page: | 1 |
| <a id="id--last_entry"></a>`id--last_entry` | `#last_entry` | th | Last Entry Sort ascending. | 1 |
...
| <a id="id--wpforms-entries-list"></a>`id--wpforms-entries-list` | `#wpforms-entries-list` | div | Entries All Forms | 1 |
| <a id="id--wpforms-entries-overview-datepicker"></a>`id--wpforms-entries-overview-datepicker` | `#wpforms-entries-overview-datepicker` | input |  | 1 |
...
| Anchor | Selector | Tag | Text | Count |
| --- | --- | --- | --- | --- |
| <a id="class--wpforms-admin-content"></a>`class--wpforms-admin-content` | `.wpforms-admin-content` | div | All Forms | 1 |
...
| <a id="class--wpforms-overview-chart-notice"></a>`class--wpforms-overview-chart-notice` | `.wpforms-overview-chart-notice` | div | No entries for selected period Please select a different pe… | 1 |
| <a id="class--wpforms-overview-chart-notice-content"></a>`class--wpforms-overview-chart-notice-content` | `.wpforms-overview-chart-notice-content` | div | No entries for selected period Please select a different pe… | 1 |
