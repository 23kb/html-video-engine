...
| --- | --- | --- | --- | --- |
| <a id="id--adv-settings"></a>`id--adv-settings` | `#adv-settings` | form | Additional information Advanced details Log | 1 |
| <a id="id--advanced"></a>`id--advanced` | `#advanced` | input | Advanced details Log | 1 |
...
| <a id="id--log"></a>`id--log` | `#log` | input | Log | 1 |
| <a id="id--post-body"></a>`id--post-body` | `#post-body` | div | Payment Details #2 | 1 |
| <a id="id--post-body-content"></a>`id--post-body-content` | `#post-body-content` | div | Payment Details #2 | 1 |
| <a id="id--postbox-container-1"></a>`id--postbox-container-1` | `#postbox-container-1` | div | Details | 1 |
| <a id="id--poststuff"></a>`id--poststuff` | `#poststuff` | div | Payment Details #2 | 1 |
...
| <a id="id--screenoptionnonce"></a>`id--screenoptionnonce` | `#screenoptionnonce` | input |  | 2 |
...
| <a id="id--wpforms-payment-details"></a>`id--wpforms-payment-details` | `#wpforms-payment-details` | div | Details | 1 |
| <a id="id--wpforms-payment-entry-fields"></a>`id--wpforms-payment-entry-fields` | `#wpforms-payment-entry-fields` | div | Entry Summary #7100 | 1 |
| <a id="id--wpforms-payment-info"></a>`id--wpforms-payment-info` | `#wpforms-payment-info` | div | Payment Details #2 | 1 |
| <a id="id--wpforms-payments"></a>`id--wpforms-payments` | `#wpforms-payments` | div | Payments Back to All Payments | 1 |
| <a id="id--wpforms-payments-single-refund"></a>`id--wpforms-payments-single-refund` | `#wpforms-payments-single-refund` | a | Refund | 1 |
...
| <a id="id--wpforms-single-payment-tooltip-content-method"></a>`id--wpforms-single-payment-tooltip-content-method` | `#wpforms-single-payment-tooltip-content-method` | span | xxxx xxxx xxxx 0366 | 1 |
...
| Anchor | Selector | Tag | Text | Count |
| --- | --- | --- | --- | --- |
| <a id="class--wpforms-admin-content"></a>`class--wpforms-admin-content` | `.wpforms-admin-content` | div | Payment Details #2 | 1 |
...
| <a id="class--wpforms-payment-entry-field"></a>`class--wpforms-payment-entry-field` | `.wpforms-payment-entry-field` | div | Name Sullie Tester | 4 |
| <a id="class--wpforms-payments-details-stat-card"></a>`class--wpforms-payments-details-stat-card` | `.wpforms-payments-details-stat-card` | li | Total $100.00 | 4 |
...
| <a id="class--wpforms-single-payment-tooltip-content"></a>`class--wpforms-single-payment-tooltip-content` | `.wpforms-single-payment-tooltip-content` | span | xxxx xxxx xxxx 0366 | 1 |
