...
| <a id="id--wpforms-paypal-commerce-disconnect-sandbox"></a>`id--wpforms-paypal-commerce-disconnect-sandbox` | `#wpforms-paypal-commerce-disconnect-sandbox` | a | Disconnect | 1 |
| <a id="id--wpforms-setting-currency"></a>`id--wpforms-setting-currency` | `#wpforms-setting-currency` | select | U.S. Dollar (USD $) | 1 |
| <a id="id--wpforms-setting-paypal-commerce-sandbox-mode"></a>`id--wpforms-setting-paypal-commerce-sandbox-mode` | `#wpforms-setting-paypal-commerce-sandbox-mode` | input | On Prevent PayPal Commerce from processing live transaction… | 1 |
| <a id="id--wpforms-setting-paypal-commerce-webhooks-enabled"></a>`id--wpforms-setting-paypal-commerce-webhooks-enabled` | `#wpforms-setting-paypal-commerce-webhooks-enabled` | input | On PayPal uses webhooks to notify WPForms when events occur… | 1 |
...
| <a id="id--wpforms-setting-row-paypal-commerce-sandbox-mode"></a>`id--wpforms-setting-row-paypal-commerce-sandbox-mode` | `#wpforms-setting-row-paypal-commerce-sandbox-mode` | div | Test Mode | 1 |
| <a id="id--wpforms-setting-row-paypal-commerce-webhooks-enabled"></a>`id--wpforms-setting-row-paypal-commerce-webhooks-enabled` | `#wpforms-setting-row-paypal-commerce-webhooks-enabled` | div | Enable Webhooks | 1 |
| <a id="id--wpforms-setting-row-square-connection-status-production"></a>`id--wpforms-setting-row-square-connection-status-production` | `#wpforms-setting-row-square-connection-status-production` | div | Connection Status | 1 |
| <a id="id--wpforms-setting-row-square-connection-status-sandbox"></a>`id--wpforms-setting-row-square-connection-status-sandbox` | `#wpforms-setting-row-square-connection-status-sandbox` | div | Connection Status | 1 |
| <a id="id--wpforms-setting-row-square-heading"></a>`id--wpforms-setting-row-square-heading` | `#wpforms-setting-row-square-heading` | div | Square Easily collect credit card payments with Square. For… | 1 |
| <a id="id--wpforms-setting-row-square-sandbox-mode"></a>`id--wpforms-setting-row-square-sandbox-mode` | `#wpforms-setting-row-square-sandbox-mode` | div | Test Mode | 1 |
| <a id="id--wpforms-setting-row-stripe-connection-status"></a>`id--wpforms-setting-row-stripe-connection-status` | `#wpforms-setting-row-stripe-connection-status` | div | Connection Status | 1 |
| <a id="id--wpforms-setting-row-stripe-heading"></a>`id--wpforms-setting-row-stripe-heading` | `#wpforms-setting-row-stripe-heading` | div | Stripe Easily collect credit card payments with Stripe. For… | 1 |
| <a id="id--wpforms-setting-row-stripe-live-publishable-key"></a>`id--wpforms-setting-row-stripe-live-publishable-key` | `#wpforms-setting-row-stripe-live-publishable-key` | div | Live Publishable Key | 1 |
| <a id="id--wpforms-setting-row-stripe-live-secret-key"></a>`id--wpforms-setting-row-stripe-live-secret-key` | `#wpforms-setting-row-stripe-live-secret-key` | div | Live Secret Key | 1 |
| <a id="id--wpforms-setting-row-stripe-test-mode"></a>`id--wpforms-setting-row-stripe-test-mode` | `#wpforms-setting-row-stripe-test-mode` | div | Test Mode | 1 |
| <a id="id--wpforms-setting-row-stripe-test-publishable-key"></a>`id--wpforms-setting-row-stripe-test-publishable-key` | `#wpforms-setting-row-stripe-test-publishable-key` | div | Test Publishable Key | 1 |
| <a id="id--wpforms-setting-row-stripe-test-secret-key"></a>`id--wpforms-setting-row-stripe-test-secret-key` | `#wpforms-setting-row-stripe-test-secret-key` | div | Test Secret Key | 1 |
| <a id="id--wpforms-setting-row-stripe-webhooks-enabled"></a>`id--wpforms-setting-row-stripe-webhooks-enabled` | `#wpforms-setting-row-stripe-webhooks-enabled` | div | Enable Webhooks | 1 |
| <a id="id--wpforms-setting-square-sandbox-mode"></a>`id--wpforms-setting-square-sandbox-mode` | `#wpforms-setting-square-sandbox-mode` | input | On Prevent Square from processing live transactions. | 1 |
| <a id="id--wpforms-setting-stripe-live-publishable-key"></a>`id--wpforms-setting-stripe-live-publishable-key` | `#wpforms-setting-stripe-live-publishable-key` | input | Live Secret Key | 1 |
| <a id="id--wpforms-setting-stripe-live-secret-key"></a>`id--wpforms-setting-stripe-live-secret-key` | `#wpforms-setting-stripe-live-secret-key` | input | PayPal Commerce Easily collect PayPal Checkout and credit c… | 1 |
| <a id="id--wpforms-setting-stripe-test-mode"></a>`id--wpforms-setting-stripe-test-mode` | `#wpforms-setting-stripe-test-mode` | input | On Prevent Stripe from processing live transactions. Please… | 1 |
...
| Anchor | Selector | Tag | Text | Count |
| --- | --- | --- | --- | --- |
| <a id="class--choices__input"></a>`class--choices__input` | `.choices__input` | select | U.S. Dollar (USD $) | 2 |
| <a id="class--choices__input--cloned"></a>`class--choices__input--cloned` | `.choices__input--cloned` | input | Australian Dollar (AUD $) | 1 |
...
| <a id="class--wpforms-btn"></a>`class--wpforms-btn` | `.wpforms-btn` | a | Switch Accounts | 7 |
| <a id="class--wpforms-btn-light-grey"></a>`class--wpforms-btn-light-grey` | `.wpforms-btn-light-grey` | a | Switch Accounts | 6 |
| <a id="class--wpforms-btn-md"></a>`class--wpforms-btn-md` | `.wpforms-btn-md` | a | Switch Accounts | 7 |
...
| <a id="class--wpforms-learn-more"></a>`class--wpforms-learn-more` | `.wpforms-learn-more` | a | Learn More | 6 |
| <a id="class--wpforms-link"></a>`class--wpforms-link` | `.wpforms-link` | a |  | 4 |
| <a id="class--wpforms-setting-field"></a>`class--wpforms-setting-field` | `.wpforms-setting-field` | span | Payments | 25 |
| <a id="class--wpforms-setting-label"></a>`class--wpforms-setting-label` | `.wpforms-setting-label` | span | Currency | 21 |
| <a id="class--wpforms-setting-row"></a>`class--wpforms-setting-row` | `.wpforms-setting-row` | div | Payments | 25 |
| <a id="class--wpforms-setting-row-content"></a>`class--wpforms-setting-row-content` | `.wpforms-setting-row-content` | div | Payments | 15 |
| <a id="class--wpforms-setting-row-select"></a>`class--wpforms-setting-row-select` | `.wpforms-setting-row-select` | div | Currency | 1 |
| <a id="class--wpforms-setting-row-toggle"></a>`class--wpforms-setting-row-toggle` | `.wpforms-setting-row-toggle` | div | Test Mode | 5 |
| <a id="class--wpforms-splash-modal-open"></a>`class--wpforms-splash-modal-open` | `.wpforms-splash-modal-open` | a |  | 1 |
| <a id="class--wpforms-stripe-connect-button"></a>`class--wpforms-stripe-connect-button` | `.wpforms-stripe-connect-button` | a |  | 1 |
| <a id="class--wpforms-toggle-control"></a>`class--wpforms-toggle-control` | `.wpforms-toggle-control` | span | On | 5 |
