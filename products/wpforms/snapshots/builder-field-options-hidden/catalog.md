# Catalog — `builder-field-options-hidden`

> Auto-generated. Do not edit by hand.
> Source: `snapshots/builder-field-options-hidden/index.html`
> Generator: `tools/generate-snapshot-catalog.js`
> 226 selector entries across 5 sections.

Provenance anchor form: `snapshots/builder-field-options-hidden/catalog.md#<anchor>`.
...
| <a id="id--wpforms-field-option-row-12-calculation_is_enabled"></a>`id--wpforms-field-option-row-12-calculation_is_enabled` | `#wpforms-field-option-row-12-calculation_is_enabled` | div | Enabl | 1 |
...
| <a id="id--wpforms-field-options"></a>`id--wpforms-field-options` | `#wpforms-field-options` | div | Hidden Field (ID #12) | 1 |
...
| <a id="class--wpforms-field-option"></a>`class--wpforms-field-option` | `.wpforms-field-option` | div | Hidden Field (ID #12) | 1 |
| <a id="class--wpforms-field-option-group-toggle"></a>`class--wpforms-field-option-group-toggle` | `.wpforms-field-option-group-toggle` | a | General | 2 |
| <a id="class--wpforms-field-option-hidden-id"></a>`class--wpforms-field-option-hidden-id` | `.wpforms-field-option-hidden-id` | input | Hidden Field (ID #12) General | 1 |
| <a id="class--wpforms-field-option-hidden-type"></a>`class--wpforms-field-option-hidden-type` | `.wpforms-field-option-hidden-type` | input | Hidden Field (ID #12) General | 1 |
| <a id="class--wpforms-field-option-row"></a>`class--wpforms-field-option-row` | `.wpforms-field-option-row` | div | Label | 6 |
...
| <a id="class--wpforms-field-options"></a>`class--wpforms-field-options` | `.wpforms-field-options` | div | Hidden Field (ID #12) | 1 |
...
| <a id="class--wpforms-toggle-control"></a>`class--wpforms-toggle-control` | `.wpforms-toggle-control` | span | Hide Label | 2 |
| <a id="class--wpforms-toggle-control-label"></a>`class--wpforms-toggle-control-label` | `.wpforms-toggle-control-label` | label | Hide Label | 2 |
