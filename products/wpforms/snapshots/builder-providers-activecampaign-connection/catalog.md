# Catalog — `builder-providers-activecampaign-connection`

> Auto-generated. Do not edit by hand.
> Source: `snapshots/builder-providers-activecampaign-connection/index.html`
> Generator: `tools/generate-snapshot-catalog.js`
> 256 selector entries across 4 sections.

Provenance anchor form: `snapshots/builder-providers-activecampaign-connection/catalog.md#<anchor>`.
...
| <a id="id--wpforms-builder-activecampaign-provider-19e2f0fc7d0-account"></a>`id--wpforms-builder-activecampaign-provider-19e2f0fc7d0-account` | `#wpforms-builder-activecampaign-provider-19e2f0fc7d0-account` | select | --- Select Account --- 061.umair@gmail.com | 1 |
| <a id="id--wpforms-builder-activecampaign-provider-19e2f0fc7d0-action"></a>`id--wpforms-builder-activecampaign-provider-19e2f0fc7d0-action` | `#wpforms-builder-activecampaign-provider-19e2f0fc7d0-action` | select | --- Select Action --- Subscriber: Create or Update Subscrib… | 1 |
| <a id="id--wpforms-builder-activecampaign-provider-19e2f0fc7d0-lists"></a>`id--wpforms-builder-activecampaign-provider-19e2f0fc7d0-lists` | `#wpforms-builder-activecampaign-provider-19e2f0fc7d0-lists` | select | --- Select List --- Master Contact List | 1 |
| <a id="id--wpforms-builder-activecampaign-provider-19e2f0fc7d0-name"></a>`id--wpforms-builder-activecampaign-provider-19e2f0fc7d0-name` | `#wpforms-builder-activecampaign-provider-19e2f0fc7d0-name` | input | Select Account * | 1 |
| <a id="id--wpforms-builder-activecampaign-provider-19e2f0fc7d0-note"></a>`id--wpforms-builder-activecampaign-provider-19e2f0fc7d0-note` | `#wpforms-builder-activecampaign-provider-19e2f0fc7d0-note` | textarea |  | 1 |
| <a id="id--wpforms-builder-activecampaign-provider-19e2f0fc7d0-status"></a>`id--wpforms-builder-activecampaign-provider-19e2f0fc7d0-status` | `#wpforms-builder-activecampaign-provider-19e2f0fc7d0-status` | select | --- Select Status --- Unconfirmed Active | 1 |
| <a id="id--wpforms-builder-activecampaign-provider-19e2f0fc7d0-subscriber-subscribe-tags-add"></a>`id--wpforms-builder-activecampaign-provider-19e2f0fc7d0-subscriber-subscribe-tags-add` | `#wpforms-builder-activecampaign-provider-19e2f0fc7d0-subscriber-subscribe-tags-add` | select |  | 1 |
| <a id="id--wpforms-builder-activecampaign-provider-19e2f0fc7d0-subscriber-subscribe-tags-delete"></a>`id--wpforms-builder-activecampaign-provider-19e2f0fc7d0-subscriber-subscribe-tags-delete` | `#wpforms-builder-activecampaign-provider-19e2f0fc7d0-subscriber-subscribe-tags-delete` | select |  | 1 |
| <a id="id--wpforms-builder-activecampaign-provider-19e2f0fc7d0-tags-new"></a>`id--wpforms-builder-activecampaign-provider-19e2f0fc7d0-tags-new` | `#wpforms-builder-activecampaign-provider-19e2f0fc7d0-tags-new` | input | Enter new tag name(s). Comma-separated list of tags is acce… | 1 |
...
| <a id="id--wpforms-conditional-groups-providers-activecampaign-19e2f0fc7d0"></a>`id--wpforms-conditional-groups-providers-activecampaign-19e2f0fc7d0` | `#wpforms-conditional-groups-providers-activecampaign-19e2f0fc7d0` | div | Process Don't process this connection if | 1 |
...
| <a id="id--wpforms-panel-field-activecampaign--connection_id--conditional_logic-wrap"></a>`id--wpforms-panel-field-activecampaign--connection_id--conditional_logic-wrap` | `#wpforms-panel-field-activecampaign-%connection_id%-conditional_logic-wrap` | div |  | 1 |
| <a id="id--wpforms-panel-field-activecampaign--connection_id--email-new-wrap"></a>`id--wpforms-panel-field-activecampaign--connection_id--email-new-wrap` | `#wpforms-panel-field-activecampaign-%connection_id%-email-new-wrap` | div | New Subscriber Email --- Select New Email Fiel | 1 |
| <a id="id--wpforms-panel-field-activecampaign--connection_id--email-wrap"></a>`id--wpforms-panel-field-activecampaign--connection_id--email-wrap` | `#wpforms-panel-field-activecampaign-%connection_id%-email-wrap` | div | Subscriber Email * | 1 |
| <a id="id--wpforms-panel-field-activecampaign-19e2f0fc7d0-conditional_logic"></a>`id--wpforms-panel-field-activecampaign-19e2f0fc7d0-conditional_logic` | `#wpforms-panel-field-activecampaign-19e2f0fc7d0-conditional_logic` | input | Enable Conditional Logic | 1 |
| <a id="id--wpforms-panel-field-activecampaign-19e2f0fc7d0-email"></a>`id--wpforms-panel-field-activecampaign-19e2f0fc7d0-email` | `#wpforms-panel-field-activecampaign-19e2f0fc7d0-email` | select | --- Select Email Field --- Email | 1 |
| <a id="id--wpforms-panel-field-activecampaign-19e2f0fc7d0-email-new"></a>`id--wpforms-panel-field-activecampaign-19e2f0fc7d0-email-new` | `#wpforms-panel-field-activecampaign-19e2f0fc7d0-email-new` | select | --- Select New Email Field --- Email | 1 |
...
| <a id="id--wpforms-panel-field-settings-n8n_enable-wrap"></a>`id--wpforms-panel-field-settings-n8n_enable-wrap` | `#wpforms-panel-field-settings-n8n_enable-wrap` | div | Enable n8n Integration | 1 |
...
| <a id="data-section--builder-n8n-description-55"></a>`data-section--builder-n8n-description-55` | `[data-section="builder-n8n-description-55"]` | button |  | 1 |
...
| Anchor | Selector | Tag | Text | Count |
| --- | --- | --- | --- | --- |
| <a id="class--choices__input--cloned"></a>`class--choices__input--cloned` | `.choices__input--cloned` | input | No choices to choose from Select one or more of the existin… | 2 |
| <a id="class--choices__list--dropdown"></a>`class--choices__list--dropdown` | `.choices__list--dropdown` | div | No choices to choose from | 2 |
| <a id="class--wpforms-btn"></a>`class--wpforms-btn` | `.wpforms-btn` | button | Help | 10 |
| <a id="class--wpforms-btn-blue"></a>`class--wpforms-btn-blue` | `.wpforms-btn-blue` | button | And | 2 |
...
| <a id="class--wpforms-btn-sm"></a>`class--wpforms-btn-sm` | `.wpforms-btn-sm` | button | And | 2 |
| <a id="class--wpforms-btn-toolbar"></a>`class--wpforms-btn-toolbar` | `.wpforms-btn-toolbar` | button | Help | 5 |
| <a id="class--wpforms-builder-activecampaign-provider-actions"></a>`class--wpforms-builder-activecampaign-provider-actions` | `.wpforms-builder-activecampaign-provider-actions` | div | Action To Perform * --- Se | 1 |
| <a id="class--wpforms-builder-activecampaign-provider-item-input"></a>`class--wpforms-builder-activecampaign-provider-item-input` | `.wpforms-builder-activecampaign-provider-item-input` | div | New Tags to Add Enter new tag name(s). Comma-separated list… | 1 |
| <a id="class--wpforms-builder-activecampaign-provider-subscriber-subscribe-tags-add"></a>`class--wpforms-builder-activecampaign-provider-subscriber-subscribe-tags-add` | `.wpforms-builder-activecampaign-provider-subscriber-subscribe-tags-add` | div | Tags To Add | 1 |
...
| <a id="class--wpforms-builder-provider-connection-option_id"></a>`class--wpforms-builder-provider-connection-option_id` | `.wpforms-builder-provider-connection-option_id` | input | ActiveCampaign Connection | 1 |
| <a id="class--wpforms-builder-provider-connections-error-message"></a>`class--wpforms-builder-provider-connections-error-message` | `.wpforms-builder-provider-connections-error-message` | span | Something went wrong while performing an AJAX request. | 11 |
| <a id="class--wpforms-builder-provider-connections-save-lock"></a>`class--wpforms-builder-provider-connections-save-lock` | `.wpforms-builder-provider-connections-save-lock` | input | Something went wrong while performing an AJAX request. | 14 |
| <a id="class--wpforms-builder-provider-settings-default-content"></a>`class--wpforms-builder-provider-settings-default-content` | `.wpforms-builder-provider-settings-default-content` | div | Get the most out of WPForms — use it with an active AWeber … | 16 |
| <a id="class--wpforms-builder-provider-title-add"></a>`class--wpforms-builder-provider-title-add` | `.wpforms-builder-provider-title-add` | button | Add New Connection | 28 |
| <a id="class--wpforms-builder-settings-block-actions"></a>`class--wpforms-builder-settings-block-actions` | `.wpforms-builder-settings-block-actions` | div |  | 1 |
| <a id="class--wpforms-builder-settings-block-add"></a>`class--wpforms-builder-settings-block-add` | `.wpforms-builder-settings-block-add` | button | Add New Connection | 1 |
| <a id="class--wpforms-builder-settings-block-content"></a>`class--wpforms-builder-settings-block-content` | `.wpforms-builder-settings-block-content` | div | Webhook URL | 1 |
| <a id="class--wpforms-builder-settings-block-header"></a>`class--wpforms-builder-settings-block-header` | `.wpforms-builder-settings-block-header` | div | New N8N Integration | 1 |
| <a id="class--wpforms-builder-settings-block-toggle"></a>`class--wpforms-builder-settings-block-toggle` | `.wpforms-builder-settings-block-toggle` | button |  | 1 |
| <a id="class--wpforms-conditional-block-panel"></a>`class--wpforms-conditional-block-panel` | `.wpforms-conditional-block-panel` | div |  | 2 |
| <a id="class--wpforms-conditional-field"></a>`class--wpforms-conditional-field` | `.wpforms-conditional-field` | select | --- Select Field --- Email Overall rating How likely are yo… | 1 |
...
| <a id="class--wpforms-conditional-row"></a>`class--wpforms-conditional-row` | `.wpforms-conditional-row` | tr | --- Select Field --- Email Overall rating How likely are yo… | 1 |
...
| <a id="class--wpforms-dismiss-container"></a>`class--wpforms-dismiss-container` | `.wpforms-dismiss-container` | div | Instantly send form entries to thousands of other apps via … | 1 |
| <a id="class--wpforms-field-map-custom-value"></a>`class--wpforms-field-map-custom-value` | `.wpforms-field-map-custom-value` | input | Smart Tags | 1 |
| <a id="class--wpforms-field-map-custom-value-close"></a>`class--wpforms-field-map-custom-value-close` | `.wpforms-field-map-custom-value-close` | a |  | 1 |
| <a id="class--wpforms-field-map-select"></a>`class--wpforms-field-map-select` | `.wpforms-field-map-select` | select | --- Select Email Field --- Email | 3 |
...
| <a id="class--wpforms-panel-content-section"></a>`class--wpforms-panel-content-section` | `.wpforms-panel-content-section` | div |  | 20 |
| <a id="class--wpforms-panel-field"></a>`class--wpforms-panel-field` | `.wpforms-panel-field` | div | Subscriber Email * | 11 |
...
| <a id="class--wpforms-panel-field-select"></a>`class--wpforms-panel-field-select` | `.wpforms-panel-field-select` | div | Subscriber Email * | 3 |
| <a id="class--wpforms-panel-field-toggle"></a>`class--wpforms-panel-field-toggle` | `.wpforms-panel-field-toggle` | div |  | 4 |
...
| <a id="class--wpforms-panel-sidebar"></a>`class--wpforms-panel-sidebar` | `.wpforms-panel-sidebar` | div | Default AWeber | 1 |
...
| <a id="class--wpforms-required"></a>`class--wpforms-required` | `.wpforms-required` | select | --- Select Account --- 061.umair@gmail.com | 6 |
| <a id="class--wpforms-required-url"></a>`class--wpforms-required-url` | `.wpforms-required-url` | input | Test Connection Secret Key | 1 |
...
| <a id="class--wpforms-toggle-control"></a>`class--wpforms-toggle-control` | `.wpforms-toggle-control` | span |  | 4 |
| <a id="class--wpforms-toggle-control-label"></a>`class--wpforms-toggle-control-label` | `.wpforms-toggle-control-label` | label | Enable Conditional Logic | 4 |
| <a id="class--wpforms-undo-redo-container"></a>`class--wpforms-undo-redo-container` | `.wpforms-undo-redo-container` | div | Process Don't process this connection if | 2 |
