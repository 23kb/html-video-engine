# Catalog — `builder-providers-convertkit-connection`

> Auto-generated. Do not edit by hand.
> Source: `snapshots/builder-providers-convertkit-connection/index.html`
> Generator: `tools/generate-snapshot-catalog.js`
> 254 selector entries across 4 sections.

Provenance anchor form: `snapshots/builder-providers-convertkit-connection/catalog.md#<anchor>`.
...
| <a id="id--wpforms-builder-convertkit-provider-19e2f15013b-action"></a>`id--wpforms-builder-convertkit-provider-19e2f15013b-action` | `#wpforms-builder-convertkit-provider-19e2f15013b-action` | select | --- Select Action --- Subscribe Unsubscribe Remove subscrib… | 1 |
| <a id="id--wpforms-builder-convertkit-provider-19e2f15013b-name"></a>`id--wpforms-builder-convertkit-provider-19e2f15013b-name` | `#wpforms-builder-convertkit-provider-19e2f15013b-name` | input | Select Account * --- Select --- | 1 |
...
| <a id="id--wpforms-conditional-groups-providers-convertkit-19e2f15013b"></a>`id--wpforms-conditional-groups-providers-convertkit-19e2f15013b` | `#wpforms-conditional-groups-providers-convertkit-19e2f15013b` | div | Process Don't process this connection if | 1 |
...
| <a id="id--wpforms-panel-field-convertkit--connection_id--conditional_logic-wrap"></a>`id--wpforms-panel-field-convertkit--connection_id--conditional_logic-wrap` | `#wpforms-panel-field-convertkit-%connection_id%-conditional_logic-wrap` | div |  | 1 |
| <a id="id--wpforms-panel-field-convertkit-19e2f15013b-conditional_logic"></a>`id--wpforms-panel-field-convertkit-19e2f15013b-conditional_logic` | `#wpforms-panel-field-convertkit-19e2f15013b-conditional_logic` | input | Enable Conditional Logic | 1 |
...
| Anchor | Selector | Tag | Text | Count |
| --- | --- | --- | --- | --- |
| <a id="class--choices__input--cloned"></a>`class--choices__input--cloned` | `.choices__input--cloned` | input | No choices to choose from New Tags | 1 |
| <a id="class--choices__list--dropdown"></a>`class--choices__list--dropdown` | `.choices__list--dropdown` | div | No choices to choose from | 1 |
...
| <a id="class--wpforms-builder-convertkit-new-custom-field-close"></a>`class--wpforms-builder-convertkit-new-custom-field-close` | `.wpforms-builder-convertkit-new-custom-field-close` | a |  | 1 |
| <a id="class--wpforms-builder-convertkit-provider-actions"></a>`class--wpforms-builder-convertkit-provider-actions` | `.wpforms-builder-convertkit-provider-actions` | div | Action To Perform * --- Select Action --- Subscribe | 1 |
| <a id="class--wpforms-builder-convertkit-provider-connection-email"></a>`class--wpforms-builder-convertkit-provider-connection-email` | `.wpforms-builder-convertkit-provider-connection-email` | select | --- Select Form Field --- Email | 1 |
| <a id="class--wpforms-builder-convertkit-provider-connection-first_name"></a>`class--wpforms-builder-convertkit-provider-connection-first_name` | `.wpforms-builder-convertkit-provider-connection-first_name` | select | --- Select Form Field --- Name | 1 |
| <a id="class--wpforms-builder-convertkit-provider-connection-form"></a>`class--wpforms-builder-convertkit-provider-connection-form` | `.wpforms-builder-convertkit-provider-connection-form` | select | --- Select Form --- | 1 |
| <a id="class--wpforms-builder-convertkit-provider-connection-new_email"></a>`class--wpforms-builder-convertkit-provider-connection-new_email` | `.wpforms-builder-convertkit-provider-connection-new_email` | select | --- Select Form Field --- Email | 1 |
...
| <a id="class--wpforms-builder-provider-connection-field-name"></a>`class--wpforms-builder-provider-connection-field-name` | `.wpforms-builder-provider-connection-field-name` | select | --- Select Field --- New Custom Field | 2 |
| <a id="class--wpforms-builder-provider-connection-field-value"></a>`class--wpforms-builder-provider-connection-field-value` | `.wpforms-builder-provider-connection-field-value` | input | This field accepts a comma-separated list of tags. Tags lis… | 2 |
| <a id="class--wpforms-builder-provider-connection-fields-table-row"></a>`class--wpforms-builder-provider-connection-fields-table-row` | `.wpforms-builder-provider-connection-fields-table-row` | tr | --- Select Field --- New Custom Field | 1 |
| <a id="class--wpforms-builder-provider-connection-id"></a>`class--wpforms-builder-provider-connection-id` | `.wpforms-builder-provider-connection-id` | input | Kit Connection | 1 |
