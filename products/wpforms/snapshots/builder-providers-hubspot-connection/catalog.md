# Catalog — `builder-providers-hubspot-connection`

> Auto-generated. Do not edit by hand.
> Source: `snapshots/builder-providers-hubspot-connection/index.html`
> Generator: `tools/generate-snapshot-catalog.js`
> 248 selector entries across 4 sections.

Provenance anchor form: `snapshots/builder-providers-hubspot-connection/catalog.md#<anchor>`.
...
| <a id="id--wpforms-builder-hubspot-provider-19e2f1744ea-action"></a>`id--wpforms-builder-hubspot-provider-19e2f1744ea-action` | `#wpforms-builder-hubspot-provider-19e2f1744ea-action` | select | --- Select Action --- Create/Update Contact Delete Contact … | 1 |
| <a id="id--wpforms-builder-hubspot-provider-19e2f1744ea-name"></a>`id--wpforms-builder-hubspot-provider-19e2f1744ea-name` | `#wpforms-builder-hubspot-provider-19e2f1744ea-name` | input | Select Account * --- Select --- | 1 |
...
| <a id="id--wpforms-conditional-groups-providers-hubspot-19e2f1744ea"></a>`id--wpforms-conditional-groups-providers-hubspot-19e2f1744ea` | `#wpforms-conditional-groups-providers-hubspot-19e2f1744ea` | div | Process Don't process this connection if | 1 |
...
| <a id="id--wpforms-panel-field-hubspot--connection_id--conditional_logic-wrap"></a>`id--wpforms-panel-field-hubspot--connection_id--conditional_logic-wrap` | `#wpforms-panel-field-hubspot-%connection_id%-conditional_logic-wrap` | div |  | 1 |
| <a id="id--wpforms-panel-field-hubspot-19e2f1744ea-conditional_logic"></a>`id--wpforms-panel-field-hubspot-19e2f1744ea-conditional_logic` | `#wpforms-panel-field-hubspot-19e2f1744ea-conditional_logic` | input | Enable Conditional Logic | 1 |
...
| <a id="class--wpforms-builder-hubspot-provider-actions"></a>`class--wpforms-builder-hubspot-provider-actions` | `.wpforms-builder-hubspot-provider-actions` | div | Action To Perform * --- Select Action --- Create/Update Con… | 1 |
...
| <a id="class--wpforms-builder-provider-connection-field-name"></a>`class--wpforms-builder-provider-connection-field-name` | `.wpforms-builder-provider-connection-field-name` | select | --- Select HubSpot Field --- Message Street Address | 1 |
| <a id="class--wpforms-builder-provider-connection-field-value"></a>`class--wpforms-builder-provider-connection-field-value` | `.wpforms-builder-provider-connection-field-value` | select | --- Select Email Field --- Email | 7 |
| <a id="class--wpforms-builder-provider-connection-fields-table-row"></a>`class--wpforms-builder-provider-connection-fields-table-row` | `.wpforms-builder-provider-connection-fields-table-row` | tr | --- Select HubSpot Field --- Message | 1 |
| <a id="class--wpforms-builder-provider-connection-id"></a>`class--wpforms-builder-provider-connection-id` | `.wpforms-builder-provider-connection-id` | input | HubSpot Connection | 1 |
...
| <a id="class--wpforms-builder-provider-hs-form-id"></a>`class--wpforms-builder-provider-hs-form-id` | `.wpforms-builder-provider-hs-form-id` | input | HubSpot Connection | 1 |
| <a id="class--wpforms-builder-provider-hs-portal-id"></a>`class--wpforms-builder-provider-hs-portal-id` | `.wpforms-builder-provider-hs-portal-id` | input | HubSpot Connection | 1 |
...
| <a id="class--wpforms-panel-field"></a>`class--wpforms-panel-field` | `.wpforms-panel-field` | div | Enable n8n Integration | 9 |
