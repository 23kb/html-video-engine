# Catalog — `builder-providers-mailchimpv3-connection`

> Auto-generated. Do not edit by hand.
> Source: `snapshots/builder-providers-mailchimpv3-connection/index.html`
> Generator: `tools/generate-snapshot-catalog.js`
> 258 selector entries across 4 sections.

Provenance anchor form: `snapshots/builder-providers-mailchimpv3-connection/catalog.md#<anchor>`.
...
| <a id="id--wpforms-builder-mailchimp-provider-19e2f19797a-enable-optin"></a>`id--wpforms-builder-mailchimp-provider-19e2f19797a-enable-optin` | `#wpforms-builder-mailchimp-provider-19e2f19797a-enable-optin` | input | Enable double opt-in Send contacts an opt-in confirmation e… | 1 |
| <a id="id--wpforms-builder-mailchimp-provider-19e2f19797a-mark-vip"></a>`id--wpforms-builder-mailchimp-provider-19e2f19797a-mark-vip` | `#wpforms-builder-mailchimp-provider-19e2f19797a-mark-vip` | input | Mark subscriber as VIP | 1 |
| <a id="id--wpforms-builder-mailchimp-provider-19e2f19797a-note"></a>`id--wpforms-builder-mailchimp-provider-19e2f19797a-note` | `#wpforms-builder-mailchimp-provider-19e2f19797a-note` | textarea |  | 1 |
| <a id="id--wpforms-builder-mailchimp-provider-19e2f19797a-notify-user"></a>`id--wpforms-builder-mailchimp-provider-19e2f19797a-notify-user` | `#wpforms-builder-mailchimp-provider-19e2f19797a-notify-user` | input | Notify users that they are already subscribed | 1 |
| <a id="id--wpforms-builder-mailchimp-provider-19e2f19797a-subscribe-tags-add"></a>`id--wpforms-builder-mailchimp-provider-19e2f19797a-subscribe-tags-add` | `#wpforms-builder-mailchimp-provider-19e2f19797a-subscribe-tags-add` | select |  | 1 |
| <a id="id--wpforms-builder-mailchimp-provider-19e2f19797a-subscribe-tags-delete"></a>`id--wpforms-builder-mailchimp-provider-19e2f19797a-subscribe-tags-delete` | `#wpforms-builder-mailchimp-provider-19e2f19797a-subscribe-tags-delete` | select |  | 1 |
| <a id="id--wpforms-builder-mailchimp-provider-19e2f19797a-tags-new"></a>`id--wpforms-builder-mailchimp-provider-19e2f19797a-tags-new` | `#wpforms-builder-mailchimp-provider-19e2f19797a-tags-new` | input | Comma-separated list of tags is accepted. Tags To Remove | 1 |
| <a id="id--wpforms-builder-mailchimp-provider-19e2f19797a-update-profile"></a>`id--wpforms-builder-mailchimp-provider-19e2f19797a-update-profile` | `#wpforms-builder-mailchimp-provider-19e2f19797a-update-profile` | input | Update the profile if this contact is already in an audience | 1 |
...
| <a id="id--wpforms-conditional-groups-providers-mailchimpv3-19e2f19797a"></a>`id--wpforms-conditional-groups-providers-mailchimpv3-19e2f19797a` | `#wpforms-conditional-groups-providers-mailchimpv3-19e2f19797a` | div | Process Don't process this connection if | 1 |
...
| <a id="id--wpforms-panel-field-mailchimpv3--connection_id--conditional_logic-wrap"></a>`id--wpforms-panel-field-mailchimpv3--connection_id--conditional_logic-wrap` | `#wpforms-panel-field-mailchimpv3-%connection_id%-conditional_logic-wrap` | div |  | 1 |
| <a id="id--wpforms-panel-field-mailchimpv3-19e2f19797a-conditional_logic"></a>`id--wpforms-panel-field-mailchimpv3-19e2f19797a-conditional_logic` | `#wpforms-panel-field-mailchimpv3-19e2f19797a-conditional_logic` | input | Enable Conditional Logic | 1 |
| <a id="id--wpforms-panel-field-mailchimpv3-19e2f19797a-email"></a>`id--wpforms-panel-field-mailchimpv3-19e2f19797a-email` | `#wpforms-panel-field-mailchimpv3-19e2f19797a-email` | select | --- Select Email Field --- Email | 1 |
| <a id="id--wpforms-panel-field-mailchimpv3-19e2f19797a-email-wrap"></a>`id--wpforms-panel-field-mailchimpv3-19e2f19797a-email-wrap` | `#wpforms-panel-field-mailchimpv3-19e2f19797a-email-wrap` | div | Subscriber Email * -- | 1 |
...
| <a id="class--wpforms-builder-mailchimp-provider-actions"></a>`class--wpforms-builder-mailchimp-provider-actions` | `.wpforms-builder-mailchimp-provider-actions` | div | Action To Perform * --- Select Action --- Subscribe Unsubsc… | 1 |
| <a id="class--wpforms-builder-mailchimp-provider-item-input"></a>`class--wpforms-builder-mailchimp-provider-item-input` | `.wpforms-builder-mailchimp-provider-item-input` | div | New Tags to Add Comma-separated list of tags | 1 |
| <a id="class--wpforms-builder-mailchimp-provider-subscribe-tags-add"></a>`class--wpforms-builder-mailchimp-provider-subscribe-tags-add` | `.wpforms-builder-mailchimp-provider-subscribe-tags-add` | div | Select Tags Tags To Add | 1 |
...
| <a id="class--wpforms-builder-provider-connection-field-name"></a>`class--wpforms-builder-provider-connection-field-name` | `.wpforms-builder-provider-connection-field-name` | select | --- Select Mailchimp Field --- Address Birthday Company | 1 |
...
| <a id="class--wpforms-builder-provider-connection-fields-table-row"></a>`class--wpforms-builder-provider-connection-fields-table-row` | `.wpforms-builder-provider-connection-fields-table-row` | tr | --- Select Mailchimp Field --- Address B | 1 |
| <a id="class--wpforms-builder-provider-connection-name"></a>`class--wpforms-builder-provider-connection-name` | `.wpforms-builder-provider-connection-name` | input | Select Account * --- Select Account --- | 1 |
...
| <a id="class--wpforms-field-map-select"></a>`class--wpforms-field-map-select` | `.wpforms-field-map-select` | select | --- Select Field --- Name Email Overall rating How likely a… | 2 |
...
| <a id="class--wpforms-required"></a>`class--wpforms-required` | `.wpforms-required` | input | Test Connection Secret Key | 6 |
...
| <a id="class--wpforms-toggle-control"></a>`class--wpforms-toggle-control` | `.wpforms-toggle-control` | span | Enable n8n Integration | 8 |
| <a id="class--wpforms-toggle-control-label"></a>`class--wpforms-toggle-control-label` | `.wpforms-toggle-control-label` | label | Enable n8n Integration | 8 |
