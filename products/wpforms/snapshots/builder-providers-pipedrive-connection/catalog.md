# Catalog — `builder-providers-pipedrive-connection`

> Auto-generated. Do not edit by hand.
> Source: `snapshots/builder-providers-pipedrive-connection/index.html`
> Generator: `tools/generate-snapshot-catalog.js`
> 257 selector entries across 4 sections.

Provenance anchor form: `snapshots/builder-providers-pipedrive-connection/catalog.md#<anchor>`.
...
| <a id="id--choices--wpforms-builder-pipedrive-provider-19e2f1b9f27-person_organization-item-choice-1"></a>`id--choices--wpforms-builder-pipedrive-provider-19e2f1b9f27-person_organization-item-choice-1` | `#choices--wpforms-builder-pipedrive-provider-19e2f1b9f27-person_organization-item-choice-1` | div | --- Select Organization --- | 1 |
| <a id="id--choices--wpforms-builder-pipedrive-provider-19e2f1b9f27-person_organization-item-choice-2"></a>`id--choices--wpforms-builder-pipedrive-provider-19e2f1b9f27-person_organization-item-choice-2` | `#choices--wpforms-builder-pipedrive-provider-19e2f1b9f27-person_organization-item-choice-2` | div | [Sample] MoveEr | 1 |
...
| <a id="id--js-wpforms-builder-pipedrive-provider-19e2f1b9f27-account"></a>`id--js-wpforms-builder-pipedrive-provider-19e2f1b9f27-account` | `#js-wpforms-builder-pipedrive-provider-19e2f1b9f27-account` | select | --- Select --- 061.umair@gmail.com | 1 |
| <a id="id--js-wpforms-builder-pipedrive-provider-19e2f1b9f27-action"></a>`id--js-wpforms-builder-pipedrive-provider-19e2f1b9f27-action` | `#js-wpforms-builder-pipedrive-provider-19e2f1b9f27-action` | select | --- Select Action --- Create/Update Person Create Deal | 1 |
...
| <a id="id--wpforms-builder-pipedrive-provider-19e2f1b9f27-name"></a>`id--wpforms-builder-pipedrive-provider-19e2f1b9f27-name` | `#wpforms-builder-pipedrive-provider-19e2f1b9f27-name` | input | Account * | 1 |
| <a id="id--wpforms-builder-pipedrive-provider-19e2f1b9f27-person_email"></a>`id--wpforms-builder-pipedrive-provider-19e2f1b9f27-person_email` | `#wpforms-builder-pipedrive-provider-19e2f1b9f27-person_email` | select | --- Select Form Field --- Email | 1 |
| <a id="id--wpforms-builder-pipedrive-provider-19e2f1b9f27-person_name"></a>`id--wpforms-builder-pipedrive-provider-19e2f1b9f27-person_name` | `#wpforms-builder-pipedrive-provider-19e2f1b9f27-person_name` | select | --- Select Form Field --- Name | 1 |
| <a id="id--wpforms-builder-pipedrive-provider-19e2f1b9f27-person_organization"></a>`id--wpforms-builder-pipedrive-provider-19e2f1b9f27-person_organization` | `#wpforms-builder-pipedrive-provider-19e2f1b9f27-person_organization` | select | --- Select Organization --- | 1 |
| <a id="id--wpforms-builder-pipedrive-provider-19e2f1b9f27-person_phone"></a>`id--wpforms-builder-pipedrive-provider-19e2f1b9f27-person_phone` | `#wpforms-builder-pipedrive-provider-19e2f1b9f27-person_phone` | select | --- Select Form Field --- | 1 |
...
| <a id="id--wpforms-conditional-groups-providers-pipedrive-19e2f1b9f27"></a>`id--wpforms-conditional-groups-providers-pipedrive-19e2f1b9f27` | `#wpforms-conditional-groups-providers-pipedrive-19e2f1b9f27` | div | Process Don't process this connection if | 1 |
...
| <a id="id--wpforms-panel-field-pipedrive--connection_id--conditional_logic-wrap"></a>`id--wpforms-panel-field-pipedrive--connection_id--conditional_logic-wrap` | `#wpforms-panel-field-pipedrive-%connection_id%-conditional_logic-wrap` | div |  | 1 |
| <a id="id--wpforms-panel-field-pipedrive-19e2f1b9f27-conditional_logic"></a>`id--wpforms-panel-field-pipedrive-19e2f1b9f27-conditional_logic` | `#wpforms-panel-field-pipedrive-19e2f1b9f27-conditional_logic` | input | Enable Conditional Logic | 1 |
...
| <a id="class--choices__input"></a>`class--choices__input` | `.choices__input` | select | --- Select Organization --- | 2 |
| <a id="class--choices__input--cloned"></a>`class--choices__input--cloned` | `.choices__input--cloned` | input | --- Select Organizatio | 1 |
...
| <a id="class--wpforms-builder-pipedrive-provider-actions"></a>`class--wpforms-builder-pipedrive-provider-actions` | `.wpforms-builder-pipedrive-provider-actions` | div | Action to Perform * | 1 |
| <a id="class--wpforms-builder-provider-connection-field-name"></a>`class--wpforms-builder-provider-connection-field-name` | `.wpforms-builder-provider-connection-field-name` | select | --- Select Field --- | 1 |
| <a id="class--wpforms-builder-provider-connection-field-value"></a>`class--wpforms-builder-provider-connection-field-value` | `.wpforms-builder-provider-connection-field-value` | select | --- Select Form Field --- Name | 5 |
| <a id="class--wpforms-builder-provider-connection-fields-table-row"></a>`class--wpforms-builder-provider-connection-fields-table-row` | `.wpforms-builder-provider-connection-fields-table-row` | tr | --- Select Field --- | 1 |
| <a id="class--wpforms-builder-provider-connection-id"></a>`class--wpforms-builder-provider-connection-id` | `.wpforms-builder-provider-connection-id` | input | Pipedrive Connection | 1 |
...
| <a id="class--wpforms-field-map-select"></a>`class--wpforms-field-map-select` | `.wpforms-field-map-select` | select | --- Select Field --- Name Email Overall rating How likely a… | 4 |
...
| <a id="class--wpforms-panel-field"></a>`class--wpforms-panel-field` | `.wpforms-panel-field` | div | Enable n8n Integration | 8 |
...
| <a id="class--wpforms-toggle-control"></a>`class--wpforms-toggle-control` | `.wpforms-toggle-control` | span | Enable n8n Integration | 4 |
| <a id="class--wpforms-toggle-control-label"></a>`class--wpforms-toggle-control-label` | `.wpforms-toggle-control-label` | label | Enable n8n Integration | 4 |
