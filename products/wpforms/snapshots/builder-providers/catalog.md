...
> 231 selector entries across 4 sections.
...
| <a id="id--hubspot-provider"></a>`id--hubspot-provider` | `#hubspot-provider` | div | HubSpot Add New Account | 1 |
...
| <a id="id--pipedrive-provider"></a>`id--pipedrive-provider` | `#pipedrive-provider` | div | Pipedrive Add New Account | 1 |
...
| <a id="class--wpforms-btn-md"></a>`class--wpforms-btn-md` | `.wpforms-btn-md` | a | Try Constant Contact for Free | 4 |
| <a id="class--wpforms-btn-orange"></a>`class--wpforms-btn-orange` | `.wpforms-btn-orange` | button | Save | 5 |
| <a id="class--wpforms-btn-toolbar"></a>`class--wpforms-btn-toolbar` | `.wpforms-btn-toolbar` | button | Help | 5 |
| <a id="class--wpforms-builder-accounts-pipedrive-authorize-button"></a>`class--wpforms-builder-accounts-pipedrive-authorize-button` | `.wpforms-builder-accounts-pipedrive-authorize-button` | button | Add New Account | 1 |
...
| <a id="class--wpforms-builder-provider-connections-error-message"></a>`class--wpforms-builder-provider-connections-error-message` | `.wpforms-builder-provider-connections-error-message` | span | Something went wrong while performing an AJAX request. | 9 |
| <a id="class--wpforms-builder-provider-connections-save-lock"></a>`class--wpforms-builder-provider-connections-save-lock` | `.wpforms-builder-provider-connections-save-lock` | input | Something went wrong while performing an AJAX request. | 12 |
...
| <a id="class--wpforms-builder-provider-title-add"></a>`class--wpforms-builder-provider-title-add` | `.wpforms-builder-provider-title-add` | button | Add New Connection | 22 |
...
| <a id="class--wpforms-conditional-block-panel"></a>`class--wpforms-conditional-block-panel` | `.wpforms-conditional-block-panel` | div |  | 1 |
...
| <a id="class--wpforms-hubspot-auth"></a>`class--wpforms-hubspot-auth` | `.wpforms-hubspot-auth` | button | Add New Account | 2 |
...
| <a id="class--wpforms-panel-field"></a>`class--wpforms-panel-field` | `.wpforms-panel-field` | div | Enable n8n Integration | 7 |
| <a id="class--wpforms-panel-field-conditional_logic-checkbox"></a>`class--wpforms-panel-field-conditional_logic-checkbox` | `.wpforms-panel-field-conditional_logic-checkbox` | input | Enable Conditional Logic | 1 |
...
| <a id="class--wpforms-panel-field-toggle"></a>`class--wpforms-panel-field-toggle` | `.wpforms-panel-field-toggle` | div | Enable n8n Integration | 3 |
...
| <a id="class--wpforms-required"></a>`class--wpforms-required` | `.wpforms-required` | input | Test Connection Secret Key | 2 |
| <a id="class--wpforms-required-url"></a>`class--wpforms-required-url` | `.wpforms-required-url` | input | Test Connection Secret Key | 1 |
| <a id="class--wpforms-slack-auth"></a>`class--wpforms-slack-auth` | `.wpforms-slack-auth` | button | Add New Account | 1 |
...
| <a id="class--wpforms-toggle-control"></a>`class--wpforms-toggle-control` | `.wpforms-toggle-control` | span | Enable n8n Integration | 3 |
| <a id="class--wpforms-toggle-control-label"></a>`class--wpforms-toggle-control-label` | `.wpforms-toggle-control-label` | label | Enable n8n Integration | 3 |
