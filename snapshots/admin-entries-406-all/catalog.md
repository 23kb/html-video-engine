...
| <a id="id--doaction2"></a>`id--doaction2` | `#doaction2` | input | 1,190 items « ‹ Current Page | 1 |
...
| <a id="id--wpforms-entries-table"></a>`id--wpforms-entries-table` | `#wpforms-entries-table` | form | All&nbsp; ( 1190 ) | 1 |
...
| <a id="class--wpforms-filter-date-selector"></a>`class--wpforms-filter-date-selector` | `.wpforms-filter-date-selector` | input | Filter 1,190 items | 2 |
