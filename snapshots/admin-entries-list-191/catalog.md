...
| <a id="id--cb-select-all-1"></a>`id--cb-select-all-1` | `#cb-select-all-1` | input | Select All Your name | 1 |
| <a id="id--cb-select-all-2"></a>`id--cb-select-all-2` | `#cb-select-all-2` | input | Select All Your name | 1 |
...
| <a id="id--current-page-selector"></a>`id--current-page-selector` | `#current-page-selector` | input | of 12 | 1 |
...
| <a id="id--doaction2"></a>`id--doaction2` | `#doaction2` | input | 340 items « ‹ Current Page | 1 |
...
| <a id="id--table-paging"></a>`id--table-paging` | `#table-paging` | span | 1 of 12 | 1 |
...
| <a id="id--wpforms_field_1"></a>`id--wpforms_field_1` | `#wpforms_field_1` | th | Your name | 1 |
| <a id="id--wpforms_field_1-foot"></a>`id--wpforms_field_1-foot` | `#wpforms_field_1-foot` | th | Your name | 1 |
...
| <a id="id--wpforms_field_3"></a>`id--wpforms_field_3` | `#wpforms_field_3` | th | Position | 1 |
| <a id="id--wpforms_field_3-foot"></a>`id--wpforms_field_3-foot` | `#wpforms_field_3-foot` | th | Position | 1 |
| <a id="id--wpforms-entries-list"></a>`id--wpforms-entries-list` | `#wpforms-entries-list` | div | Entries Select Form Job Application | 1 |
...
| <a id="id--wpforms-entries-table-edit-columns-select"></a>`id--wpforms-entries-table-edit-columns-select` | `#wpforms-entries-table-edit-columns-select` | select | Your name Email Position Years of experience Why are you a … | 1 |
...
| Anchor | Selector | Tag | Text | Count |
| --- | --- | --- | --- | --- |
| <a id="class--wpforms-admin-content"></a>`class--wpforms-admin-content` | `.wpforms-admin-content` | div | Select Form Job Application | 1 |
| <a id="class--wpforms-entries-table-edit-columns-select"></a>`class--wpforms-entries-table-edit-columns-select` | `.wpforms-entries-table-edit-columns-select` | select | Your name Email Position Years of experience Why are you a … | 1 |
| <a id="class--wpforms-filter-date-selector"></a>`class--wpforms-filter-date-selector` | `.wpforms-filter-date-selector` | input | Filter 340 items | 2 |
...
| <a id="class--wpforms-form-search-box-field"></a>`class--wpforms-form-search-box-field` | `.wpforms-form-search-box-field` | select | Any form field Your name Email Position Years of experience… | 1 |
...
| <a id="class--wpforms-list-table-ext-edit-columns-select"></a>`class--wpforms-list-table-ext-edit-columns-select` | `.wpforms-list-table-ext-edit-columns-select` | select | Your name Email Position Years of experience Why are you a … | 1 |
...
| <a id="class--wpforms-multiselect-checkbox-dropdown"></a>`class--wpforms-multiselect-checkbox-dropdown` | `.wpforms-multiselect-checkbox-dropdown` | div | Your name Email Position | 1 |
...
| <a id="class--wpforms-multiselect-checkbox-search"></a>`class--wpforms-multiselect-checkbox-search` | `.wpforms-multiselect-checkbox-search` | input | Form Fields Your name | 1 |
