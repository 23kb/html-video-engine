...
| <a id="id--cb-foot"></a>`id--cb-foot` | `#cb-foot` | td | Select All | 1 |
| <a id="id--cb-select-all-1"></a>`id--cb-select-all-1` | `#cb-select-all-1` | input | Select All Which treats should we bake more often? | 1 |
| <a id="id--cb-select-all-2"></a>`id--cb-select-all-2` | `#cb-select-all-2` | input | Select All Which treats should we bake more often? | 1 |
...
| <a id="id--date"></a>`id--date` | `#date` | th | Date Sort ascending. | 1 |
...
| <a id="id--wpforms_field_2"></a>`id--wpforms_field_2` | `#wpforms_field_2` | th | Email Address | 1 |
| <a id="id--wpforms_field_2-foot"></a>`id--wpforms_field_2-foot` | `#wpforms_field_2-foot` | th | Email Address | 1 |
| <a id="id--wpforms_field_5"></a>`id--wpforms_field_5` | `#wpforms_field_5` | th | Which treats should we bake more often? | 1 |
| <a id="id--wpforms_field_5-foot"></a>`id--wpforms_field_5-foot` | `#wpforms_field_5-foot` | th | Which treats should we bake more often? | 1 |
| <a id="id--wpforms-entries-list"></a>`id--wpforms-entries-list` | `#wpforms-entries-list` | div | Entries Select Form Bakery Favorites Survey | 1 |
| <a id="id--wpforms-entries-search-input"></a>`id--wpforms-entries-search-input` | `#wpforms-entries-search-input` | input | Search | 1 |
| <a id="id--wpforms-entries-table"></a>`id--wpforms-entries-table` | `#wpforms-entries-table` | form | All | 1 |
| <a id="id--wpforms-entries-table-edit-columns-select"></a>`id--wpforms-entries-table-edit-columns-select` | `#wpforms-entries-table-edit-columns-select` | select | Which treats should we bake more often? Email Address Entry… | 1 |
| <a id="id--wpforms-flyout"></a>`id--wpforms-flyout` | `#wpforms-flyout` | div | Su | 1 |
...
| Anchor | Selector | Tag | Text | Count |
| --- | --- | --- | --- | --- |
| <a id="data-field-id--5"></a>`data-field-id--5` | `[data-field-id="5"]` | div | Which treats should we bake more often? | 4 |
...
| Anchor | Selector | Tag | Text | Count |
| --- | --- | --- | --- | --- |
| <a id="class--wpforms-admin-content"></a>`class--wpforms-admin-content` | `.wpforms-admin-content` | div | Select Form Bakery Favorites Survey | 1 |
| <a id="class--wpforms-entries-table-edit-columns-select"></a>`class--wpforms-entries-table-edit-columns-select` | `.wpforms-entries-table-edit-columns-select` | select | Which treats should we bake more often? Email Address Entry… | 1 |
| <a id="class--wpforms-filter-date-selector"></a>`class--wpforms-filter-date-selector` | `.wpforms-filter-date-selector` | input | Filter 6 items | 2 |
...
| <a id="class--wpforms-form-search-box-comparison"></a>`class--wpforms-form-search-box-comparison` | `.wpforms-form-search-box-comparison` | select | contains does not contain is is not is empty is not empty | 1 |
| <a id="class--wpforms-form-search-box-field"></a>`class--wpforms-form-search-box-field` | `.wpforms-form-search-box-field` | select | Any form field Which treats should we bake more often? Emai… | 1 |
| <a id="class--wpforms-form-search-box-term"></a>`class--wpforms-form-search-box-term` | `.wpforms-form-search-box-term` | input | Search | 1 |
...
| <a id="class--wpforms-list-table-ext-edit-columns-select"></a>`class--wpforms-list-table-ext-edit-columns-select` | `.wpforms-list-table-ext-edit-columns-select` | select | Which treats should we bake more often? Email Address Entry… | 1 |
| <a id="class--wpforms-list-table-ext-edit-columns-select-container"></a>`class--wpforms-list-table-ext-edit-columns-select-container` | `.wpforms-list-table-ext-edit-columns-select-container` | div |  | 1 |
| <a id="class--wpforms-multiselect-checkbox-dropdown"></a>`class--wpforms-multiselect-checkbox-dropdown` | `.wpforms-multiselect-checkbox-dropdown` | div | Which treats should we bake more often? Email Address | 1 |
| <a id="class--wpforms-multiselect-checkbox-input"></a>`class--wpforms-multiselect-checkbox-input` | `.wpforms-multiselect-checkbox-input` | input |  | 1 |
| <a id="class--wpforms-multiselect-checkbox-items-no-search"></a>`class--wpforms-multiselect-checkbox-items-no-search` | `.wpforms-multiselect-checkbox-items-no-search` | div | Form Fields Which treats should we bake more often? Email A… | 1 |
...
| <a id="class--wpforms-survey-graph-button"></a>`class--wpforms-survey-graph-button` | `.wpforms-survey-graph-button` | button | Export | 11 |
...
| <a id="class--wpforms-survey-graph-export"></a>`class--wpforms-survey-graph-export` | `.wpforms-survey-graph-export` | button | Export | 1 |
| <a id="class--wpforms-survey-graph-header"></a>`class--wpforms-survey-graph-header` | `.wpforms-survey-graph-header` | div | Which treats should we bake more often? | 1 |
| <a id="class--wpforms-survey-graph-menu-content"></a>`class--wpforms-survey-graph-menu-content` | `.wpforms-survey-graph-menu-content` | div | Content Graph + Data | 2 |
| <a id="class--wpforms-survey-graph-menu-field"></a>`class--wpforms-survey-graph-menu-field` | `.wpforms-survey-graph-menu-field` | div | Content Graph + Data | 8 |
| <a id="class--wpforms-survey-graph-menu-footer-actions"></a>`class--wpforms-survey-graph-menu-footer-actions` | `.wpforms-survey-graph-menu-footer-actions` | div |  | 1 |
| <a id="class--wpforms-survey-graph-menu-footer-export"></a>`class--wpforms-survey-graph-menu-footer-export` | `.wpforms-survey-graph-menu-footer-export` | button | Export Results | 1 |
| <a id="class--wpforms-survey-graph-menu-footer-update-settings"></a>`class--wpforms-survey-graph-menu-footer-update-settings` | `.wpforms-survey-graph-menu-footer-update-settings` | button | Save Changes | 1 |
| <a id="class--wpforms-survey-graph-preview-question-item"></a>`class--wpforms-survey-graph-preview-question-item` | `.wpforms-survey-graph-preview-question-item` | li | Which treats should we bake more often? | 1 |
| <a id="class--wpforms-survey-graph-preview-question-item-selected"></a>`class--wpforms-survey-graph-preview-question-item-selected` | `.wpforms-survey-graph-preview-question-item-selected` | li | Which treats should we bake more often? | 1 |
| <a id="class--wpforms-survey-graph-preview-questions-dropdown"></a>`class--wpforms-survey-graph-preview-questions-dropdown` | `.wpforms-survey-graph-preview-questions-dropdown` | div | Which treats should we bake more often? | 1 |
| <a id="class--wpforms-survey-graph-view-all"></a>`class--wpforms-survey-graph-view-all` | `.wpforms-survey-graph-view-all` | a | View Survey Results | 3 |
| <a id="class--wpforms-survey-minicolor-input"></a>`class--wpforms-survey-minicolor-input` | `.wpforms-survey-minicolor-input` | input | Graph Size | 1 |
| <a id="class--wpforms-survey-question-content"></a>`class--wpforms-survey-question-content` | `.wpforms-survey-question-content` | div |  | 2 |
| <a id="class--wpforms-table-container"></a>`class--wpforms-table-container` | `.wpforms-table-container` | div | Select All | 1 |
