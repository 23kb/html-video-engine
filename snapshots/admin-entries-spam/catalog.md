...
| <a id="id--bulk-action-selector-bottom"></a>`id--bulk-action-selector-bottom` | `#bulk-action-selector-bottom` | select | Bulk actions Mark as Read Mark as Unread ---------- Mark as… | 1 |
| <a id="id--bulk-action-selector-top"></a>`id--bulk-action-selector-top` | `#bulk-action-selector-top` | select | Bulk actions Mark as Read Mark as Unread ---------- Mark as… | 1 |
...
| <a id="id--current-page-selector"></a>`id--current-page-selector` | `#current-page-selector` | input | of 2 | 1 |
| <a id="id--date"></a>`id--date` | `#date` | th | Date Sort ascending. | 1 |
| <a id="id--date-foot"></a>`id--date-foot` | `#date-foot` | th | Date Sort ascending. | 1 |
| <a id="id--doaction"></a>`id--doaction` | `#doaction` | input | Empty Spam 32 items | 1 |
| <a id="id--doaction2"></a>`id--doaction2` | `#doaction2` | input | Empty Spam 32 items | 1 |
...
| <a id="id--wpforms-entries-list"></a>`id--wpforms-entries-list` | `#wpforms-entries-list` | div | Entries Spam entries older than 90 days are automatically d… | 1 |
...
| <a id="id--wpforms-notice-2"></a>`id--wpforms-notice-2` | `#wpforms-notice-2` | div | Spam entries older than 90 days are automatically deleted. | 1 |
...
| <a id="class--wpforms-multiselect-checkbox-dropdown"></a>`class--wpforms-multiselect-checkbox-dropdown` | `.wpforms-multiselect-checkbox-dropdown` | div | Name Email Comment or Message | 1 |
...
| <a id="class--wpforms-notice"></a>`class--wpforms-notice` | `.wpforms-notice` | div | Spam entries older than 90 days are automatically deleted. | 1 |
