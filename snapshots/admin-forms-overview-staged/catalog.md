# Catalog — `admin-forms-overview-staged`

> Auto-generated. Do not edit by hand.
> Source: `snapshots/admin-forms-overview-staged/index.html`
> Generator: `tools/generate-snapshot-catalog.js`
> 104 selector entries across 2 sections.

Provenance anchor form: `snapshots/admin-forms-overview-staged/catalog.md#<anchor>`.
...
| --- | --- | --- | --- | --- |
| <a id="id--adv-settings"></a>`id--adv-settings` | `#adv-settings` | form | Pagination Number of forms per page: | 1 |
| <a id="id--analytics_conversion"></a>`id--analytics_conversion` | `#analytics_conversion` | th | Conversion | 1 |
| <a id="id--analytics_conversion-foot"></a>`id--analytics_conversion-foot` | `#analytics_conversion-foot` | th | Conversion | 1 |
| <a id="id--analytics_interactions"></a>`id--analytics_interactions` | `#analytics_interactions` | th | Interactions | 1 |
| <a id="id--analytics_interactions-foot"></a>`id--analytics_interactions-foot` | `#analytics_interactions-foot` | th | Interactions | 1 |
| <a id="id--analytics_views"></a>`id--analytics_views` | `#analytics_views` | th | Views | 1 |
| <a id="id--analytics_views-foot"></a>`id--analytics_views-foot` | `#analytics_views-foot` | th | Views | 1 |
| <a id="id--author"></a>`id--author` | `#author` | th | Author Sort ascending. | 1 |
| <a id="id--author-foot"></a>`id--author-foot` | `#author-foot` | th | Author Sort ascending. | 1 |
| <a id="id--bulk-action-selector-bottom"></a>`id--bulk-action-selector-bottom` | `#bulk-action-selector-bottom` | select | Bulk actions Move to Trash Edit Tags | 1 |
| <a id="id--bulk-action-selector-top"></a>`id--bulk-action-selector-top` | `#bulk-action-selector-top` | select | Bulk actions Move to Trash Edit Tags | 1 |
...
| <a id="id--cog"></a>`id--cog` | `#cog` | th |  | 1 |
| <a id="id--cog-foot"></a>`id--cog-foot` | `#cog-foot` | th |  | 1 |
...
| <a id="id--doaction2"></a>`id--doaction2` | `#doaction2` | input |  | 1 |
| <a id="id--entries"></a>`id--entries` | `#entries` | th | Entries | 1 |
| <a id="id--entries-foot"></a>`id--entries-foot` | `#entries-foot` | th | Entries | 1 |
...
| <a id="id--id-foot"></a>`id--id-foot` | `#id-foot` | th | ID Sort ascending. | 1 |
| <a id="id--loading"></a>`id--loading` | `#loading` | img |  | 1 |
| <a id="id--locations"></a>`id--locations` | `#locations` | th | Locations | 1 |
| <a id="id--locations-foot"></a>`id--locations-foot` | `#locations-foot` | th | Locations | 1 |
| <a id="id--name"></a>`id--name` | `#name` | th | Name Sort ascending. | 1 |
| <a id="id--name-foot"></a>`id--name-foot` | `#name-foot` | th | Name Sort ascending. | 1 |
| <a id="id--pagination_per_page"></a>`id--pagination_per_page` | `#pagination_per_page` | input | View Show form te | 1 |
...
| <a id="id--shortcode"></a>`id--shortcode` | `#shortcode` | th | Shortcode | 1 |
| <a id="id--shortcode-foot"></a>`id--shortcode-foot` | `#shortcode-foot` | th | Shortcode | 1 |
...
| <a id="id--wpforms-forms-table-edit-columns-select"></a>`id--wpforms-forms-table-edit-columns-select` | `#wpforms-forms-table-edit-columns-select` | select | ID Name Tags Author Shortcode Date En | 1 |
...
| <a id="id--wpforms-overview"></a>`id--wpforms-overview` | `#wpforms-overview` | div | Forms Overview | 1 |
| <a id="id--wpforms-overview-search-term"></a>`id--wpforms-overview-search-term` | `#wpforms-overview-search-term` | input | Search Forms All&nbsp; (40) \| Forms&nbsp; (40) \| | 1 |
| <a id="id--wpforms-overview-table"></a>`id--wpforms-overview-table` | `#wpforms-overview-table` | form | Search Forms: | 1 |
...
| <a id="class--wpforms-analytics-conversion-link"></a>`class--wpforms-analytics-conversion-link` | `.wpforms-analytics-conversion-link` | a | 100.0% | 35 |
| <a id="class--wpforms-analytics-interactions-link"></a>`class--wpforms-analytics-interactions-link` | `.wpforms-analytics-interactions-link` | a | 0 | 40 |
| <a id="class--wpforms-analytics-views-link"></a>`class--wpforms-analytics-views-link` | `.wpforms-analytics-views-link` | a | 0 | 40 |
...
| <a id="class--wpforms-forms-search-box-term"></a>`class--wpforms-forms-search-box-term` | `.wpforms-forms-search-box-term` | input | Search Forms All&nbsp; (40) \| Forms&nbsp; (40) \| | 1 |
| <a id="class--wpforms-forms-table-edit-columns-select"></a>`class--wpforms-forms-table-edit-columns-select` | `.wpforms-forms-table-edit-columns-select` | select | ID Name Tags Author Shortcode Date En | 1 |
...
| <a id="class--wpforms-list-table-ext-edit-columns-select"></a>`class--wpforms-list-table-ext-edit-columns-select` | `.wpforms-list-table-ext-edit-columns-select` | select | ID Name Tags Author Shortcode Date En | 1 |
| <a id="class--wpforms-locations-link"></a>`class--wpforms-locations-link` | `.wpforms-locations-link` | a | /catering-request/ | 6 |
...
| <a id="class--wpforms-multiselect-checkbox-items-no-search"></a>`class--wpforms-multiselect-checkbox-items-no-search` | `.wpforms-multiselect-checkbox-items-no-search` | div | Columns Name Author | 1 |
| <a id="class--wpforms-row-message"></a>`class--wpforms-row-message` | `.wpforms-row-message` | tr |  | 1 |
...
| <a id="class--wpforms-tags-filter"></a>`class--wpforms-tags-filter` | `.wpforms-tags-filter` | div |  | 2 |
