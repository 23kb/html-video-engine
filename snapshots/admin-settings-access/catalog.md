...
| <a id="id--wpforms-setting-row-access-entries-heading"></a>`id--wpforms-setting-row-access-entries-heading` | `#wpforms-setting-row-access-entries-heading` | div | Entries Select the user roles that are allowed to manage en… | 1 |
| <a id="id--wpforms-setting-row-access-forms-heading"></a>`id--wpforms-setting-row-access-forms-heading` | `#wpforms-setting-row-access-forms-heading` | div | Forms Select the user roles that are allowed to manage form… | 1 |
| <a id="id--wpforms-setting-row-access-heading"></a>`id--wpforms-setting-row-access-heading` | `#wpforms-setting-row-access-heading` | div | Access By default, all permissions are provided only to adm… | 1 |
| <a id="id--wpforms-setting-row-create_forms"></a>`id--wpforms-setting-row-create_forms` | `#wpforms-setting-row-create_forms` | div | Create Forms | 1 |
| <a id="id--wpforms-setting-row-delete_entries"></a>`id--wpforms-setting-row-delete_entries` | `#wpforms-setting-row-delete_entries` | div | Delete Entries | 1 |
| <a id="id--wpforms-setting-row-delete_forms"></a>`id--wpforms-setting-row-delete_forms` | `#wpforms-setting-row-delete_forms` | div | Delete Forms | 1 |
| <a id="id--wpforms-setting-row-edit_entries"></a>`id--wpforms-setting-row-edit_entries` | `#wpforms-setting-row-edit_entries` | div | Edit Entries | 1 |
| <a id="id--wpforms-setting-row-edit_forms"></a>`id--wpforms-setting-row-edit_forms` | `#wpforms-setting-row-edit_forms` | div | Edit Forms | 1 |
| <a id="id--wpforms-setting-row-view_entries"></a>`id--wpforms-setting-row-view_entries` | `#wpforms-setting-row-view_entries` | div | View Entries | 1 |
| <a id="id--wpforms-setting-row-view_forms"></a>`id--wpforms-setting-row-view_forms` | `#wpforms-setting-row-view_forms` | div | View Forms | 1 |
| <a id="id--wpforms-setting-wpforms_create_forms"></a>`id--wpforms-setting-wpforms_create_forms` | `#wpforms-setting-wpforms_create_forms` | select | Author | 1 |
| <a id="id--wpforms-setting-wpforms_delete_entries_others_forms"></a>`id--wpforms-setting-wpforms_delete_entries_others_forms` | `#wpforms-setting-wpforms_delete_entries_others_forms` | select |  | 1 |
| <a id="id--wpforms-setting-wpforms_delete_entries_own_forms"></a>`id--wpforms-setting-wpforms_delete_entries_own_forms` | `#wpforms-setting-wpforms_delete_entries_own_forms` | select |  | 1 |
| <a id="id--wpforms-setting-wpforms_delete_others_forms"></a>`id--wpforms-setting-wpforms_delete_others_forms` | `#wpforms-setting-wpforms_delete_others_forms` | select |  | 1 |
| <a id="id--wpforms-setting-wpforms_delete_own_forms"></a>`id--wpforms-setting-wpforms_delete_own_forms` | `#wpforms-setting-wpforms_delete_own_forms` | select |  | 1 |
| <a id="id--wpforms-setting-wpforms_edit_entries_others_forms"></a>`id--wpforms-setting-wpforms_edit_entries_others_forms` | `#wpforms-setting-wpforms_edit_entries_others_forms` | select |  | 1 |
| <a id="id--wpforms-setting-wpforms_edit_entries_own_forms"></a>`id--wpforms-setting-wpforms_edit_entries_own_forms` | `#wpforms-setting-wpforms_edit_entries_own_forms` | select |  | 1 |
| <a id="id--wpforms-setting-wpforms_edit_others_forms"></a>`id--wpforms-setting-wpforms_edit_others_forms` | `#wpforms-setting-wpforms_edit_others_forms` | select |  | 1 |
| <a id="id--wpforms-setting-wpforms_edit_own_forms"></a>`id--wpforms-setting-wpforms_edit_own_forms` | `#wpforms-setting-wpforms_edit_own_forms` | select | Author | 1 |
| <a id="id--wpforms-setting-wpforms_view_entries_others_forms"></a>`id--wpforms-setting-wpforms_view_entries_others_forms` | `#wpforms-setting-wpforms_view_entries_others_forms` | select | Editor Subscriber | 1 |
...
| Anchor | Selector | Tag | Text | Count |
| --- | --- | --- | --- | --- |
| <a id="class--choices__button"></a>`class--choices__button` | `.choices__button` | button | Remove item | 11 |
| <a id="class--choices__input"></a>`class--choices__input` | `.choices__input` | select | Author | 26 |
| <a id="class--choices__list--dropdown"></a>`class--choices__list--dropdown` | `.choices__list--dropdown` | div | Contributor | 13 |
...
| <a id="class--wpforms-setting-field"></a>`class--wpforms-setting-field` | `.wpforms-setting-field` | span | Access By default, all permissions are provided only to adm… | 10 |
| <a id="class--wpforms-setting-label"></a>`class--wpforms-setting-label` | `.wpforms-setting-label` | span | Create Forms | 7 |
| <a id="class--wpforms-setting-row"></a>`class--wpforms-setting-row` | `.wpforms-setting-row` | div | Access By default, all permissions are provided only to adm… | 10 |
| <a id="class--wpforms-setting-row-content"></a>`class--wpforms-setting-row-content` | `.wpforms-setting-row-content` | div | Access By default, all permissions are provided only to adm… | 3 |
