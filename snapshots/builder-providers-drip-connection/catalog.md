# Catalog — `builder-providers-drip-connection`

> Auto-generated. Do not edit by hand.
> Source: `snapshots/builder-providers-drip-connection/index.html`
> Generator: `tools/generate-snapshot-catalog.js`
> 258 selector entries across 4 sections.

Provenance anchor form: `snapshots/builder-providers-drip-connection/catalog.md#<anchor>`.
...
| <a id="id--wpforms-builder-drip-provider-19e2f162894-account"></a>`id--wpforms-builder-drip-provider-19e2f162894-account` | `#wpforms-builder-drip-provider-19e2f162894-account` | select | --- Select Account --- WPForms | 1 |
| <a id="id--wpforms-builder-drip-provider-19e2f162894-action"></a>`id--wpforms-builder-drip-provider-19e2f162894-action` | `#wpforms-builder-drip-provider-19e2f162894-action` | select | --- Select Action --- Subscriber: Create or Update Subscrib… | 1 |
| <a id="id--wpforms-builder-drip-provider-19e2f162894-name"></a>`id--wpforms-builder-drip-provider-19e2f162894-name` | `#wpforms-builder-drip-provider-19e2f162894-name` | input | Select Account * | 1 |
| <a id="id--wpforms-builder-drip-provider-19e2f162894-prospect-score"></a>`id--wpforms-builder-drip-provider-19e2f162894-prospect-score` | `#wpforms-builder-drip-provider-19e2f162894-prospect-score` | input | Lead scoring must be enabled in Drip and is only available … | 1 |
| <a id="id--wpforms-builder-drip-provider-19e2f162894-subscriber-ip_address"></a>`id--wpforms-builder-drip-provider-19e2f162894-subscriber-ip_address` | `#wpforms-builder-drip-provider-19e2f162894-subscriber-ip_address` | input | Send user IP address to Drip | 1 |
| <a id="id--wpforms-builder-drip-provider-19e2f162894-subscriber-prospect"></a>`id--wpforms-builder-drip-provider-19e2f162894-subscriber-prospect` | `#wpforms-builder-drip-provider-19e2f162894-subscriber-prospect` | input | Mark user as a prospect | 1 |
| <a id="id--wpforms-builder-drip-provider-19e2f162894-subscriber-subscribe-tags-add"></a>`id--wpforms-builder-drip-provider-19e2f162894-subscriber-subscribe-tags-add` | `#wpforms-builder-drip-provider-19e2f162894-subscriber-subscribe-tags-add` | input | Tags To Delete | 1 |
| <a id="id--wpforms-builder-drip-provider-19e2f162894-subscriber-subscribe-tags-delete"></a>`id--wpforms-builder-drip-provider-19e2f162894-subscriber-subscribe-tags-delete` | `#wpforms-builder-drip-provider-19e2f162894-subscriber-subscribe-tags-delete` | input | Custom Fields Custom Field Name Form Field Value | 1 |
| <a id="id--wpforms-builder-drip-provider-19e2f162894-subscriber-user_id"></a>`id--wpforms-builder-drip-provider-19e2f162894-subscriber-user_id` | `#wpforms-builder-drip-provider-19e2f162894-subscriber-user_id` | input | Send user ID to Drip (if the user was logged in) Make sure … | 1 |
...
| <a id="id--wpforms-conditional-groups-providers-drip-19e2f162894"></a>`id--wpforms-conditional-groups-providers-drip-19e2f162894` | `#wpforms-conditional-groups-providers-drip-19e2f162894` | div | Process Don't process this connection if | 1 |
...
| <a id="id--wpforms-panel-field-drip--connection_id--conditional_logic-wrap"></a>`id--wpforms-panel-field-drip--connection_id--conditional_logic-wrap` | `#wpforms-panel-field-drip-%connection_id%-conditional_logic-wrap` | div |  | 1 |
| <a id="id--wpforms-panel-field-drip--connection_id-fields-email-wrap"></a>`id--wpforms-panel-field-drip--connection_id-fields-email-wrap` | `#wpforms-panel-field-drip-%connection_id%][fields-email-wrap` | div | Subscriber Email * --- Select E | 1 |
| <a id="id--wpforms-panel-field-drip--connection_id-fields-new_email-wrap"></a>`id--wpforms-panel-field-drip--connection_id-fields-new_email-wrap` | `#wpforms-panel-field-drip-%connection_id%][fields-new_email-wrap` | div | New Subscriber Email --- Select New Email Field --- | 1 |
| <a id="id--wpforms-panel-field-drip-19e2f162894-conditional_logic"></a>`id--wpforms-panel-field-drip-19e2f162894-conditional_logic` | `#wpforms-panel-field-drip-19e2f162894-conditional_logic` | input | Enable Conditional Logic | 1 |
| <a id="id--wpforms-panel-field-drip-19e2f162894-fields-email"></a>`id--wpforms-panel-field-drip-19e2f162894-fields-email` | `#wpforms-panel-field-drip-19e2f162894][fields-email` | select | --- Select Email Field --- Email | 1 |
| <a id="id--wpforms-panel-field-drip-19e2f162894-fields-new_email"></a>`id--wpforms-panel-field-drip-19e2f162894-fields-new_email` | `#wpforms-panel-field-drip-19e2f162894][fields-new_email` | select | --- Select New Email Field --- Email | 1 |
...
| <a id="class--wpforms-builder-drip-provider-actions"></a>`class--wpforms-builder-drip-provider-actions` | `.wpforms-builder-drip-provider-actions` | div | Action To Perform * --- Select Action --- | 1 |
| <a id="class--wpforms-builder-drip-provider-subscriber-subscribe-tags-add"></a>`class--wpforms-builder-drip-provider-subscriber-subscribe-tags-add` | `.wpforms-builder-drip-provider-subscriber-subscribe-tags-add` | div | Tags To Add | 1 |
...
| <a id="class--wpforms-builder-provider-connection-field-name"></a>`class--wpforms-builder-provider-connection-field-name` | `.wpforms-builder-provider-connection-field-name` | select | --- Select Field --- Custom Value First name Last name | 1 |
...
| <a id="class--wpforms-builder-provider-connection-fields-table-row"></a>`class--wpforms-builder-provider-connection-fields-table-row` | `.wpforms-builder-provider-connection-fields-table-row` | tr | --- Select Field --- Custom Value First name | 1 |
| <a id="class--wpforms-builder-provider-connection-option_id"></a>`class--wpforms-builder-provider-connection-option_id` | `.wpforms-builder-provider-connection-option_id` | input | Drip Connection | 1 |
...
| <a id="class--wpforms-field-map-select"></a>`class--wpforms-field-map-select` | `.wpforms-field-map-select` | select | --- Select Field --- Name Email Overall rating How likely a… | 3 |
...
| <a id="class--wpforms-panel-field"></a>`class--wpforms-panel-field` | `.wpforms-panel-field` | div | Enable n8n Integration | 13 |
...
| <a id="class--wpforms-panel-field-select"></a>`class--wpforms-panel-field-select` | `.wpforms-panel-field-select` | div | Trigger Event Form Submitted Entry Marked as Spam | 3 |
| <a id="class--wpforms-panel-field-toggle"></a>`class--wpforms-panel-field-toggle` | `.wpforms-panel-field-toggle` | div | Enable n8n Integration | 4 |
...
| <a id="class--wpforms-required"></a>`class--wpforms-required` | `.wpforms-required` | input | Test Connection Secret Key | 5 |
| <a id="class--wpforms-required-url"></a>`class--wpforms-required-url` | `.wpforms-required-url` | input | Test Connection Secret Key | 1 |
| <a id="class--wpforms-smart-tags-enabled"></a>`class--wpforms-smart-tags-enabled` | `.wpforms-smart-tags-enabled` | input | Smart Tags | 1 |
...
| <a id="class--wpforms-toggle-control"></a>`class--wpforms-toggle-control` | `.wpforms-toggle-control` | span | Enable n8n Integration | 7 |
| <a id="class--wpforms-toggle-control-label"></a>`class--wpforms-toggle-control-label` | `.wpforms-toggle-control-label` | label | Enable n8n Integration | 7 |
